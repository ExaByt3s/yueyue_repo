...
$certificate_teacher_train_type = pai_mall_load_config('certificate_teacher_train_type');//作品类型
...
$certificate_teacher_train_type_new = array_to_square_array($certificate_teacher_train_type);
...
$tpl->assign("certificate_teacher_train_type",$certificate_teacher_train_type_new);
