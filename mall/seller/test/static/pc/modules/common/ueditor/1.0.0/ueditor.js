define('common/ueditor/1.0.0/ueditor', function(require, exports, module){ (function()
{
	require('common/ueditor/1.0.0/ueditor.config');
	require('common/ueditor/1.0.0/ueditor.all');
                                            ...
                                            upload_obj.on('uploadProgress',function()
                                            {
                                                ...
                                                .on('uploadSuccess',function(file,response)
                                                {
                                                    ...
                                                    try{
                                                        ...
                                                        self.editor.execCommand('inserthtml', '<img class="loadingclass" id="' + file_id + '" src="'+'http://static.yueus.com/mall/seller/test/static/pc/modules/common/ueditor/1.0.0/themes/default/images/spacer.gif'+'" >');
