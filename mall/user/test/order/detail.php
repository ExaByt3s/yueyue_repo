...
// if($ret_order_full_info['is_buyer_del'] == 1)
// {
//     echo "<script>alert('订单不存在，请返回');</script>";
//     exit('订单不存在，请返回');
// }
...
// 处理星星bug
// hudw 2015.9.28
//  确认是服务订单详情才处理，此处包含活动订单，活动订单没这个数据 by 汤圆修改 2015.11.11

if ($ret_order_full_info['detail_list']) 
{
