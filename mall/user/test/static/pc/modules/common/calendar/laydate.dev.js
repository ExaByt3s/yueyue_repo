...
{
	var url = 'http://static.yueus.com/mall/user/test/static/pc/modules/common/calendar/laydate.dev.js'.split('/');
}
else
{
	var url = 'http://static-c.yueus.com/mall/user/static/pc/modules/common/calendar/laydate.dev.js'.split('/');
}
