...
$temp_ret = get_api_result('customer/goods_list.php',array(
...
$page_obj->file = "list.php?";
$total_count = $temp_ret['data']['total'];
$show_count = 9 ;
...
$tpl->assign('title',mb_convert_encoding($_INPUT['title'], 'gbk', 'utf8'));
