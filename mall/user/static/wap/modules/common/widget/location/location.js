define('common/widget/location/location', function(require, exports, module){ /**
 *  汤圆
 *  2015-7-13
 *  地区组件
 */
...
// 全部城市
var all_city = require('common/widget/location/all_city');
    ...
    navigation : function() 
    {
        ...
        self.navigation_ele.on('touchstart', function(ev) {
            ...
            function goto_cur_city() 
            {
                ...
                {
                    window.scrollTo(0, $('[data-id='+location_name+']').offset().top );
