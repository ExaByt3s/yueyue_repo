...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  return buffer;
    ...
    reduce : function() 
    {
        ...
        {
            alert('所填数字不得小于'+self.data.min_val);
            return ;
        }
        ...
        self.reduce_ele.trigger('reduce');
    },
    ...
    add : function() 
    {
        ...
        {
            alert('所填数字不得大于'+self.data.max_val);
            return ;
        }

        self.set_val(btn_value);
        self.add_ele.trigger('add')
    },
