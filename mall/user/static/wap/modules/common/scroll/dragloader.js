define('common/scroll/dragloader', function(require, exports, module){ (function(window) {
    ...
    var DragLoader = function(el, options) {
		...
		this.ct.parentNode.style.position = 'relative';
		this.ct.parentNode.style.height = '100%';
    ...
    DragLoader.prototype = {
        ...
        _createDragUpRegion: function() {
            ...
            this.footer.style.cssText = 'position:relative;bottom:0;left:0;margin:0;padding:0;overflow:hidden;width:100%;height:40px;';
