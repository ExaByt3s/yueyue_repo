...
function program1(depth0,data) {
  ...
  buffer += escapeExpression(stack1)
    + "</p>\r\n	</li>\r\n    <li>\r\n        <div>规格：";
  stack1 = helpers['if'].call(depth0, (depth0 && depth0.prices_spec), {hash:{},inverse:self.program(4, program4, data),fn:self.program(2, program2, data),data:data});
...
function program4(depth0,data) {
  ...
  stack1 = helpers.each.call(depth0, ((stack1 = (depth0 && depth0.data)),stack1 == null || stack1 === false ? stack1 : stack1.detail_list), {hash:{},inverse:self.noop,fn:self.program(1, program1, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
