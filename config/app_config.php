...
return array(
    ...
    'CUSTOM_ARRAY_SETTING' => array(
    	...
    	'pai_payment_config.php' => 'payment',
    	'pai_weixin_pub_config.php' => 'weixin_pub',
        'pai_tip_config.php'=>'pai_tip',
        'pai_gearman_config.php'=> 'pai_gearman'
    )
);
