...
//    $web_package_version_dir = '1.0.1';//最新版本号的路径文件， 网页最新资源包
//    
...
//                            );
    ...
    $lowest_version = '1.2.0'; // 最低版本号，此处不能随意修改
    $web_package_version_dir = '1.2.0';//最新版本号的路径文件， 网页最新资源包
    ...
    if($bs_version == '88.8.8') {
        $lowest_version = '1.3.0'; // 最低版本号，此处不能随意修改
        $web_package_version_dir = '1.3.0';//最新版本号的路径文件， 网页最新资源包
