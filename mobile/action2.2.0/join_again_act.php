...
if($has_join == 0)
{
	...
	*/
	...
	$notify_url         = G_PAI_APP_DOMAIN . '/mobile/' . basename(dirname(__FILE__)) . "/pay_activity_notify.php?share_event_id={$share_event_id}&share_phone={$share_phone}";
