<?php
    ...
    /*************************此处用于配置********************************/
    $lowest_version = '2.2.0'; // 最低版本号，此处不能随意修改
    $web_package_version_dir = '2.2.0';//最新版本号的路径文件， 网页最新资源包
    ...
    foreach ($web_package_arr as $key => $value) 
    {
        ...
        {
            $web_package_arr[$key]['dir'] = $web_package_arr[$lowest_version]['dir'];
        }
    }
    
    
    
    $output['packageUrl'] = 'http://yp-wifi.yueus.com/mobile/reative_native_package/app_version_zip/'.$web_package_arr[$appver]['dir'].'_app.zip';
    $output['no_wifi_packageUrl'] = 'http://yp.yueus.com/mobile/reative_native_package/app_version_zip/'.$web_package_arr[$appver]['dir'].'_app.zip';
    $output['packageVer'] = $web_package_arr[$appver]['package_ver'];
    $output['packageForceUpdate'] = 'http://yp-wifi.yueus.com/mobile/app';
    $output['enterUrl'] = 'index.ios.bundle';
    $output['no_wifi_enterUrl'] = 'index.ios.bundle';
