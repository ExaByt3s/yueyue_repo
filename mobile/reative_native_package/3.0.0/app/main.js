...
var yue_sj_trade=require('react-native/yueyue_src/yue_hot_sj_trade');
var yue_my_info=require('react-native/yueyue_src/yue_sj_my');
var yue_intro=require('react-native/yueyue_src/yue_sj_my_intro');
var yue_cover=require('react-native/yueyue_src/yue_sj_my_cover');
var yue_service=require('react-native/yueyue_src/yue_sj_my_service');
var message_view=require('react-native/yueyue_src/yue_sj_message');var 


StyleSheet=

React.StyleSheet;var NavigatorIOS=React.NavigatorIOS;var NativeModules=React.NativeModules;var 

pid_project=(function(_React$Component){
function pid_project(props){var _this=this;_classCallCheck(this, pid_project);
_get(Object.getPrototypeOf(pid_project.prototype), 'constructor', this).call(this, props);

if(this.props.pid == '1250001'){
this.state = {
pid:'1250001', 
is_loading:false};}else 

if(this.props.pid == '1250002'){
this.state = {
pid:'1250002', 
is_loading:false};}else 

if(this.props.pid == '1250004'){
var param=['user_id'];
this.state = {
pid:'1250004', 
is_loading:true, 
...
NativeModules.yue_hot_react_call.get_url_val_by_param(param, function(info){
if(info.user_id){
_this.setState({is_loading:false, user_id:info.user_id});}});}else 


if(this.props.pid == '1250005'){
var param=['user_id'];
...
if(this.props.pid == '1250006'){
var param=['user_id'];

this.state = {
pid:'1250006', 
is_loading:true};}}_inherits(pid_project, _React$Component);_createClass(pid_project, [{key:'render', value:
...
React.createElement(View, {style:styles.tbl_p_view}, 
React.createElement(View, {style:[styles.yue_info_status, {height:this.state.status_height}]}), 
React.createElement(View, {style:styles.yue_info}, 
React.createElement(TouchableHighlight, {onPress:function(){return _this2.back();}, style:styles.yue_my_info_header_touch}, React.createElement(Image, {style:styles.yue_my_info_right, source:{uri:'http://facebook.github.io/react/img/logo_og.png'}}))), 


React.createElement(View, {style:styles.yue_my_hr}), 
spin);}else 

{
if(this.state.pid == '1250001'){


return (
React.createElement(NavigatorIOS, {style:styles.tabContent, initialRoute:{title:'', component:yue_sj_trade, passProps:{screen_info:this.props}}, navigationBarHidden:true}));}else 

if(this.state.pid == '1250002'){
return (
React.createElement(NavigatorIOS, {style:styles.tabContent, initialRoute:{title:'', component:yue_my_info, passProps:{screen_info:this.props}}, navigationBarHidden:true}));}else 

if(this.state.pid == '1250003'){
return (
React.createElement(NavigatorIOS, {style:styles.tabContent, initialRoute:{title:'', component:message_view, passProps:{screen_info:this.props}}, navigationBarHidden:true}));}else 

if(this.state.pid == '1250004'){
return (
React.createElement(NavigatorIOS, {style:styles.tabContent, initialRoute:{title:'', component:yue_cover, passProps:{screen_info:this.props, user_id:this.state.user_id}}, navigationBarHidden:'true'}));}else 

if(this.state.pid == '1250005'){
return (
React.createElement(NavigatorIOS, {style:styles.tabContent, initialRoute:{title:'', component:yue_intro, passProps:{screen_info:this.props, user_id:this.state.user_id}}, navigationBarHidden:'true'}));}else 

if(this.state.pid == '1250006'){
return (
React.createElement(NavigatorIOS, {style:styles.tabContent, initialRoute:{title:'', component:yue_service, passProps:{screen_info:this.props}}, navigationBarHidden:'true'}));}else 

{
return React.createElement(View, null);}}}}]);return pid_project;})(React.Component);





React.AppRegistry.registerComponent('test_project', function(){return test_project;});
React.AppRegistry.registerComponent('my_cover', function(){return my_cover;});
React.AppRegistry.registerComponent('pid_project', function(){return pid_project;});
...
this._didCreateRequest.bind(this));}}, {key:'sendImplSup', value:



function sendImplSup(method, url, headers, option, data){
if(typeof data === 'string'){
data = {string:data};}
...
this._headers[header.toLowerCase()] = value;}}, {key:'setOption', value:


function setOption(objkey, value){
if(this.readyState !== this.OPENED){
throw new Error('Request has not been opened');}

this._option[objkey.toLowerCase()] = value;}}, {key:'open', value:
...
function sendImpl(method, url, headers, data){
throw new Error('Subclass must define sendImpl method');}}, {key:'sendImplSup', value:


function sendImplSup(method, url, headers, option, data){
throw new Error('Subclass must define sendImplSup method');}}, {key:'abortImpl', value:
...
this._sent = true;
this.sendImpl(this._method, this._url, this._headers, data);}}, {key:'sendSup', value:

function sendSup(data){
if(this.readyState !== this.OPENED){
throw new Error('Request has not been opened');}
...
this._sent = true;
this.sendImplSup(this._method, this._url, this._headers, this._option, data);}}, {key:'abort', value:
...
this.referrer = null;
this.timeoutInterval = options.timeoutInterval || '30';
...
var optionkey='timeoutInterval';
xhr.setOption(optionkey, request.timeoutInterval);
xhr.sendSup(typeof request._bodyInit === 'undefined'?null:request._bodyInit);});};
...
get_current_idx:this.get_current_idx};}, 
...
return this.state.routeStack.length - 1;}, 
...
__d('react-native/yueyue_src/yue_hot_sj_trade',["react-native/Libraries/react-native/react-native","react-native/yueyue_src/yue_sj_trade_detail","react-native/yueyue_src/yue_sj_button","react-native/yueyue_src/yue_sj_base","react-native/yueyue_src/yue_sj_my","react-native/Libraries/react-native/react-native"],function(global, require, requireDynamic, requireLazy, module, exports) {  'use strict';var _createClass=(function(){function defineProperties(target, props){for(var i=0; i < props.length; i++) {var descriptor=props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if('value' in descriptor)descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}return function(Constructor, protoProps, staticProps){if(protoProps)defineProperties(Constructor.prototype, protoProps);if(staticProps)defineProperties(Constructor, staticProps);return Constructor;};})();var _get=function get(object, property, receiver){var desc=Object.getOwnPropertyDescriptor(object, property);if(desc === undefined){var parent=Object.getPrototypeOf(object);if(parent === null){return undefined;}else {return get(parent, property, receiver);}}else if('value' in desc){return desc.value;}else {var getter=desc.get;if(getter === undefined){return undefined;}return getter.call(receiver);}};function _classCallCheck(instance, Constructor){if(!(instance instanceof Constructor)){throw new TypeError('Cannot call a class as a function');}}function _inherits(subClass, superClass){if(typeof superClass !== 'function' && superClass !== null){throw new TypeError('Super expression must either be null or a function, not ' + typeof superClass);}subClass.prototype = Object.create(superClass && superClass.prototype, {constructor:{value:subClass, enumerable:false, writable:true, configurable:true}});if(superClass)subClass.__proto__ = superClass;}

var React=require('react-native/Libraries/react-native/react-native');
var trade_detail=require('react-native/yueyue_src/yue_sj_trade_detail');
var Yue_sj_button=require('react-native/yueyue_src/yue_sj_button');var 
...
React.StatusBarIOS;var StyleSheet=React.StyleSheet;var ScrollView=React.ScrollView;var TabBarIOS=React.TabBarIOS;var NativeModules=React.NativeModules;var ActivityIndicatorIOS=React.ActivityIndicatorIOS;var Text=React.Text;var ListView=React.ListView;var TouchableHighlight=React.TouchableHighlight;var View=React.View;var AlertIOS=React.AlertIOS;var Image=React.Image;var WebView=React.WebView;
...
yue_my_info_bottom_left:{
backgroundColor:'#faa', 
alignItems:'center'}, 

yue_my_info_bottom_certer:{
backgroundColor:'#afa', 
alignItems:'center'}, 

yue_my_info_bottom_right:{
backgroundColor:'#aaf', 
alignItems:'center'}, 

yue_my_info_bottom_txt:{
textAlign:'center', 
fontSize:16, 
marginTop:17}, 
...
yue_my_srl_text_normal:{
height:30, 
backgroundColor:'#fff'}, 

yue_trade_list_header:{
flex:1, 
flexDirection:'row', 
justifyContent:'space-between', 
marginTop:10, 
...
yue_trade_list_right:{
marginRight:10}, 

yue_trade_list_money:{
flex:1, 
flexDirection:'row', 
alignSelf:'flex-end', 
marginRight:10}, 
...
yue_trade_list_info_thumb:{
width:100, 
height:100, 
marginLeft:10, 
marginRight:10}, 

yue_trade_list_info_text:{
marginRight:10, 
...
yue_hot_sj_trade=(function(_React$Component){



function yue_hot_sj_trade(props){_classCallCheck(this, yue_hot_sj_trade);
_get(Object.getPrototypeOf(yue_hot_sj_trade.prototype), 'constructor', this).call(this, props);
StatusBarIOS.setStyle(0);
var ds=new ListView.DataSource({rowHasChanged:function(r1, r2){return r1 !== r2;}});
this.state = {
is_loading:true, 
width:props.screen_info.screen_width / 3, 
height:props.screen_info.screen_height, 
status_height:props.screen_info.status_height, 
current_idx:0, 
_qrcode_state:1, 
order_data:{}, 
_result_info:[], 
...
this.load_data(0);}_inherits(yue_hot_sj_trade, _React$Component);_createClass(yue_hot_sj_trade, [{key:'deal_info', value:
...
this.setState({_result_info:list, is_loading:false, dataSource:ds.cloneWithRows(list)});}}}else 


{
this.setState({is_loading:false});}}else 

{
this.setState({is_loading:false, error_msg:info.ERROR_MSG});}}}, {key:'load_data', value:



function load_data(idx){var _this=this;
var trade_type=['all', 'unpaid', 'tbc', 'checkin', 'completed', 'closed'];
this.setState({is_loading:true, current_idx:idx, error_msg:null});
NativeModules.yue_hot_react_call.request_hasId_by_url('http://yp.yueus.com/mobile_app/merchant/trade_list.php', 'http://yp-wifi.yueus.com/mobile_app/merchant/trade_list.php', {time_out:15, trade_type:trade_type[idx]}, function(info){
_this.deal_info(info);});}}, {key:'show_qrcode', value:



function show_qrcode(){var _this2=this;
NativeModules.yue_hot_react_call.is_login(null, function(isLogin){
if(isLogin){
_this2.register_notify('qrcode_success_react', function(url){return _this2.deal_qrcode(url);});
NativeModules.yue_hot_react_call.show_qrcode();}else 
{
NativeModules.yue_hot_react_call.login();}});}}, {key:'show_message', value:




function show_message(){var _this3=this;
NativeModules.yue_hot_react_call.is_login(null, function(isLogin){
if(isLogin){
NativeModules.yue_hot_react_call.show_message();
var sj_base=require('react-native/yueyue_src/yue_sj_base');
_this3.props.navigator.replace({
title:'', 
component:sj_base, 
passProps:
_this3.props});}else 
...
{
NativeModules.yue_hot_react_call.login();}});}}, {key:'show_mine', value:





function show_mine(){var _this4=this;

NativeModules.yue_hot_react_call.is_login(null, function(isLogin){
if(isLogin){
var yue_my_info=require('react-native/yueyue_src/yue_sj_my');
_this4.props.navigator.replace({
title:'', 
component:yue_my_info, 
passProps:
_this4.props});}else 


{
NativeModules.yue_hot_react_call.login();}});}}, {key:'refresh_data_by_idx', value:





function refresh_data_by_idx(idx){
this.load_data(idx);}}, {key:'deal_qrcode', value:


function deal_qrcode(qrcode_info){var _this5=this;
var url=qrcode_info.qrcode_url;

if(url){
if(url.length){
if(this.state._qrcode_state == 1){
this.setState({is_loading:true});
NativeModules.yue_hot_react_call.request_hasId_by_url('http://yp.yueus.com/mobile_app/merchant/trade_operate.php', 'http://yp-wifi.yueus.com/mobile_app/merchant/trade_operate.php', {time_out:15, 'order_sn':this.state.order_data['order_sn'], 'operate':this.state.order_data['operate'], 'code_sn':url}, function(info){
if(info.ERROR_CODE){
alert(info.ERROR_MSG);}else 
{
if(info.code == 200){
if(info.data){
if(info.data.result == 1)
_this5.refresh_data_by_idx(_this5.current_idx);else 
alert(info.data.message);}else 
alert(info.message);}}



_this5.setState({is_loading:false});});}else 
...
this.unregister_notify('qrcode_success_react', function(url){return _this5.deal_qrcode(url);});}}, {key:'componentWillMount', value:


function componentWillMount(){}}, {key:'srl_select_idx', value:



function srl_select_idx(idx){
this.setState({current_idx:idx});}}, {key:'register_notify', value:


function register_notify(notify, handler){var _require=
require('react-native/Libraries/react-native/react-native');var DeviceEventEmitter=_require.DeviceEventEmitter;
this.state.subscription = DeviceEventEmitter.addListener(notify, handler);}}, {key:'unregister_notify', value:


function unregister_notify(notify, handler){
this.state.subscription.remove(notify);}}, {key:'componentWillUnmount', value:


function componentWillUnmount(){}}, {key:'get_row_spin', value:


function get_row_spin(spin, another_spin){
return React.createElement(View, {style:{flex:1, flexDirection:'row'}}, spin, another_spin);}}, {key:'call_trade_detail', value:


function call_trade_detail(url){var _this6=this;
var param=['order_sn', 'user_id'];
NativeModules.yue_hot_react_call.get_url_val_by_param(param, url, function(call_back){
_this6.props.navigator.push({title:'trade_detail', component:trade_detail, passProps:{data:call_back, screen_info:_this6.props.screen_info}});});}}, {key:'deal_trade_order', value:



function deal_trade_order(order, type, root){var _this7=this;
if(type == 'sign'){
root.state.order_data = {'order_sn':order, 'operate':type};
root.state._qrcode_state = 1;
root.register_notify('qrcode_success_react', function(url){return _this7.deal_qrcode(url);});
NativeModules.yue_hot_react_call.show_qrcode();}else 
{
root.setState({is_loading:true});
NativeModules.yue_hot_react_call.request_hasId_by_url('http://yp.yueus.com/mobile_app/merchant/trade_operate.php', 'http://yp-wifi.yueus.com/mobile_app/merchant/trade_operate.php', {time_out:15, 'order_sn':order, 'operate':type}, function(info){
if(info.ERROR_CODE){
alert(info.ERROR_MSG);}else 
{
if(info.code == 200){
if(info.data){
if(info.data.result == 1)
root.refresh_data_by_idx(root.current_idx);else 
alert(info.data.message);}else 
alert(info.message);}}



root.setState({is_loading:false});});}}}, {key:'html_info', value:




function html_info(){
return '<html>';}}, {key:'renderRow', value:


function renderRow(rowData, sectionID, rowID){
var spin=null;
var actions=rowData.action;

for(var i=0; i < actions.length; i++) {
var req=actions[i].request;
spin = rowData.delg.get_row_spin(spin, React.createElement(TouchableHighlight, {onPress:function(tag){return rowData.delg.deal_trade_order(rowData.order_sn, actions[tag].request, rowData.delg);}, tag:i}, React.createElement(Text, {style:styles.yue_trade_list_btn_style}, actions[i].title)));}


return React.createElement(TouchableHighlight, {onPress:function(){return rowData.delg.call_trade_detail(rowData.link);}}, 
React.createElement(View, {style:styles.yue_my_list_style}, 
React.createElement(View, {style:styles.yue_trade_list_header}, 
React.createElement(Text, {style:styles.yue_trade_list_left}, rowData.title, '>'), 
React.createElement(Text, {style:styles.yue_trade_list_right}, rowData.status)), 

React.createElement(View, {style:styles.yue_trade_list_info}, 
React.createElement(Image, {source:{uri:rowData.thumb}, style:styles.yue_trade_list_info_thumb}), 
React.createElement(View, {style:{flex:1, flexDirection:'column', width:rowData.delg.state.width * 3 - 100}}, 
React.createElement(Text, {style:[styles.yue_trade_list_info_text, {width:rowData.delg.state.width * 3 - 130}], numberOfLines:0}, rowData.desc))), 


React.createElement(View, {style:styles.yue_trade_list_money}, 
React.createElement(Text, null, rowData.cost)), 

React.createElement(View, {style:styles.yue_trade_list_btn}, 
spin), 

React.createElement(View, {style:{height:1, backgroundColor:'#eee'}})));}}, {key:'render', value:




function render(){var _this8=this;
var spin, error=null, tbl=null;



if(this.state.is_loading){
spin = 
React.createElement(View, {style:[styles.centering, {marginLeft:this.state.width * 1.5 - 43.5, marginTop:-(this.state.height / 2 + 43.5), position:'absolute', borderRadius:5}]}, 
React.createElement(ActivityIndicatorIOS, {
color:'#fff', 
style:[{height:87, width:87, opacity:0.7, backgroundColor:'#000', borderRadius:5}], 
size:'small'}));}else 
...
error = React.createElement(Text, {style:{lineHeight:this.state.height - this.state.status_height - 93}}, 'this.state.error_msg');}else 
{
error = React.createElement(View, {style:styles.yue_my_list_style}, 
React.createElement(ListView, {
style:styles.yue_my_tbl, 
...
React.createElement(View, {style:[styles.yue_info_status, {height:this.state.status_height}]}), 
React.createElement(View, {style:styles.yue_info}, 
React.createElement(Text, {style:styles.yue_my_info_left}, '约约-商家版'), 
React.createElement(Yue_sj_button, {buttonProps:{normal:'https://ss2.baidu.com/6ONYsjip0QIZ8tyhnq/it/u=3088020551,4198140884&fm=96', high:'http://wiki.jikexueyuan.com/project/react-native/cover/logo.png'}, style:{width:30, height:30, marginTop:7, marginRight:10}, onPress:function(tag){return alert('ASLJKDHLAKSHDKL');}})), 

React.createElement(View, {style:styles.yue_my_hr}), 
React.createElement(View, {style:styles.yue_my_srl}, 
React.createElement(ScrollView, {automaticallyAdjustContentInsets:false, contentInset:{top:0, bottom:0}, horizontal:true}, 
React.createElement(TouchableHighlight, {style:[styles.yue_my_srl_text_normal, {width:this.state.width / 2, backgroundColor:this.state.current_idx == 0?'#f00':'#fff'}], onPress:function(){return _this8.refresh_data_by_idx(0);}}, 
React.createElement(Text, {style:styles.yue_my_srl_text}, '全部')), 

React.createElement(TouchableHighlight, {style:[styles.yue_my_srl_text_normal, {width:this.state.width / 2, backgroundColor:this.state.current_idx == 1?'#f00':'#fff'}], onPress:function(){return _this8.refresh_data_by_idx(1);}}, 
React.createElement(Text, {style:styles.yue_my_srl_text}, '待付款')), 

React.createElement(TouchableHighlight, {style:[styles.yue_my_srl_text_normal, {width:this.state.width / 2, backgroundColor:this.state.current_idx == 2?'#f00':'#fff'}], onPress:function(){return _this8.refresh_data_by_idx(2);}}, 
React.createElement(Text, {style:styles.yue_my_srl_text}, '待确认')), 

React.createElement(TouchableHighlight, {style:[styles.yue_my_srl_text_normal, {width:this.state.width / 2, backgroundColor:this.state.current_idx == 3?'#f00':'#fff'}], onPress:function(){return _this8.refresh_data_by_idx(3);}}, 
React.createElement(Text, {style:styles.yue_my_srl_text}, '待签到')), 

React.createElement(TouchableHighlight, {style:[styles.yue_my_srl_text_normal, {width:this.state.width / 2, backgroundColor:this.state.current_idx == 4?'#f00':'#fff'}], onPress:function(){return _this8.refresh_data_by_idx(4);}}, 
React.createElement(Text, {style:styles.yue_my_srl_text}, '待评价')), 

React.createElement(TouchableHighlight, {style:[styles.yue_my_srl_text_normal, {width:this.state.width / 2, backgroundColor:this.state.current_idx == 5?'#f00':'#fff'}], onPress:function(){return _this8.refresh_data_by_idx(5);}}, 
React.createElement(Text, {style:styles.yue_my_srl_text}, '已完成'))), 


React.createElement(View, {style:{height:1, backgroundColor:'#eee'}})), 

error, 
React.createElement(View, {style:styles.yue_my_info_bottom}, 
React.createElement(TouchableHighlight, {style:[styles.yue_my_info_bottom_left, {width:this.state.width}], onPress:function(){return _this8.show_message();}}, React.createElement(Text, {style:styles.yue_my_info_bottom_txt}, '消息')), 
React.createElement(TouchableHighlight, {style:[styles.yue_my_info_bottom_certer, {width:this.state.width}]}, React.createElement(Text, {style:styles.yue_my_info_bottom_txt}, '交易')), 
React.createElement(TouchableHighlight, {style:[styles.yue_my_info_bottom_right, {width:this.state.width}], onPress:function(){return _this8.show_mine();}}, React.createElement(Text, {style:styles.yue_my_info_bottom_txt}, '我的'))), 

spin));}}]);return yue_hot_sj_trade;})(React.Component);





module.exports = yue_hot_sj_trade;});
__d('react-native/yueyue_src/yue_sj_trade_detail',["react-native/Libraries/react-native/react-native"],function(global, require, requireDynamic, requireLazy, module, exports) {  'use strict';var _createClass=(function(){function defineProperties(target, props){for(var i=0; i < props.length; i++) {var descriptor=props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if('value' in descriptor)descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}return function(Constructor, protoProps, staticProps){if(protoProps)defineProperties(Constructor.prototype, protoProps);if(staticProps)defineProperties(Constructor, staticProps);return Constructor;};})();var _get=function get(object, property, receiver){var desc=Object.getOwnPropertyDescriptor(object, property);if(desc === undefined){var parent=Object.getPrototypeOf(object);if(parent === null){return undefined;}else {return get(parent, property, receiver);}}else if('value' in desc){return desc.value;}else {var getter=desc.get;if(getter === undefined){return undefined;}return getter.call(receiver);}};function _classCallCheck(instance, Constructor){if(!(instance instanceof Constructor)){throw new TypeError('Cannot call a class as a function');}}function _inherits(subClass, superClass){if(typeof superClass !== 'function' && superClass !== null){throw new TypeError('Super expression must either be null or a function, not ' + typeof superClass);}subClass.prototype = Object.create(superClass && superClass.prototype, {constructor:{value:subClass, enumerable:false, writable:true, configurable:true}});if(superClass)subClass.__proto__ = superClass;}
...
React.StyleSheet;var Text=React.Text;var TextInput=React.TextInput;var View=React.View;var StatusBarIOS=React.StatusBarIOS;var ListView=React.ListView;var TouchableHighlight=React.TouchableHighlight;var ActivityIndicatorIOS=React.ActivityIndicatorIOS;var NativeModules=React.NativeModules;var Image=React.Image;var Component=React.Component;
...
yue_trade_detail_status_left:{
flex:1, 
flexDirection:'column'}, 

yue_trade_detail_status_left_top:{
margin:10}, 

yue_trade_detail_status_left_bottom:{
marginLeft:10}, 

yue_trade_detail_status_right:{
height:50, 
fontSize:16, 
marginTop:17, 
marginRight:10}, 

yue_trade_detail_customer:{
height:50, 
fontSize:16, 
lineHeight:16, 
paddingTop:17, 
...
yue_trade_detail_goods_thumb_info:{
flex:1, 
flexDirection:'row', 
margin:10}, 

yue_trade_detail_goods_thumb:{
width:100, 
height:100, 
marginRight:10}, 

yue_trade_detail_goods_info:{
paddingTop:5}, 

yue_trade_detail_goods_desp:{
marginLeft:10, 
marginTop:10}});var 



yue_sj_trade_detail=(function(_React$Component){
function yue_sj_trade_detail(props){_classCallCheck(this, yue_sj_trade_detail);
_get(Object.getPrototypeOf(yue_sj_trade_detail.prototype), 'constructor', this).call(this, props);
var ds=new ListView.DataSource({rowHasChanged:function(r1, r2){return r1 !== r2;}});

this.state = {
is_loading:true, 
width:props.screen_info.screen_width, 
_result_info:{}, 
status_height:props.screen_info.status_height, 
dataSource:ds.cloneWithRows([]), 
order_sn:props.data.order_sn, 
user_id:props.data.user_id};


this.load_data();}_inherits(yue_sj_trade_detail, _React$Component);_createClass(yue_sj_trade_detail, [{key:'load_data', value:


function load_data(){var _this=this;
NativeModules.yue_hot_react_call.request_hasId_by_url('http://yp.yueus.com/mobile_app/merchant/trade_info.php', 'http://yp-wifi.yueus.com/mobile_app/merchant/trade_info.php', {time_out:15, user_id:this.state.user_id, order_sn:this.state.order_sn}, function(info){
_this.deal_info(info);});}}, {key:'deal_info', value:



function deal_info(info){
if(!info.ERROR_CODE && info.code == 200){
info = info.data;
var goods_pro=['status_str', 'expire_time', 'cost'], goods_pro_array=[];
var goods_status={};

for(var i=0; i < goods_pro.length; i++) {
var pro=info[goods_pro[i]];
goods_status[goods_pro[i]] = pro;}


goods_status.display_type = 'status';
goods_status.delg = this;
goods_pro_array[goods_pro_array.length] = goods_status;

if(info.customer){
var customer={};
customer.name = info.customer;
customer.delg = this;
customer.display_type = 'customer';
goods_pro_array[goods_pro_array.length] = customer;}


if(info.detail_list){
var detail_list={};
detail_list.data = info.detail_list;
detail_list.delg = this;
detail_list.order_sn = info.order_sn;
detail_list.pay_time = info.pay_time;
detail_list.add_time = info.add_time;
detail_list.customer_service = info.customer_service;
detail_list.display_type = 'detail';
goods_pro_array[goods_pro_array.length] = detail_list;}


var ds=new ListView.DataSource({rowHasChanged:function(r1, r2){return r1 !== r2;}});
this.setState({_result_info:info, is_loading:false, dataSource:ds.cloneWithRows(goods_pro_array)});}else 
{
this.setState({_result_info:info, is_loading:false});}}}, {key:'back', value:



function back(){
if(this.props.navigator.get_current_idx() != 0)
this.props.navigator.pop();else 
{
NativeModules.yue_hot_react_call.go_back_nav();}}}, {key:'get_row_spin', value:



function get_row_spin(spin, another_spin){
return React.createElement(View, {style:{flex:1, flexDirection:'row'}}, spin, another_spin);}}, {key:'get_spin', value:


function get_spin(spin, another_spin){
return React.createElement(View, null, spin, another_spin);}}, {key:'renderRow', value:


function renderRow(rowData, sectionID, rowID){
var type=rowData.display_type;
if(type == 'status'){
return React.createElement(View, null, 
React.createElement(View, {style:styles.yue_trade_detail_status}, 
React.createElement(View, null, 
React.createElement(Text, {style:styles.yue_trade_detail_status_left_top}, rowData.status_str), 
React.createElement(Text, {style:styles.yue_trade_detail_status_left_bottom}, rowData.expire_time)), 

React.createElement(Text, {style:styles.yue_trade_detail_status_right}, '总价:', rowData.cost)), 

React.createElement(View, {style:{height:1, backgroundColor:'#eee'}}));}else 

if(type == 'customer'){
return React.createElement(View, null, 
React.createElement(Text, {style:styles.yue_trade_detail_customer}, '买家:', rowData.name), 
React.createElement(View, {style:{height:1, backgroundColor:'#eee'}}));}else 
...
var info=rowData.data[i], pros;

img = rowData.delg.get_spin(img, React.createElement(View, {style:styles.yue_trade_detail_goods_thumb_info}, 
React.createElement(Image, {source:{uri:info.goods_images}, style:styles.yue_trade_detail_goods_thumb}), 
React.createElement(Text, {style:[styles.yue_trade_detail_goods_info, {width:rowData.delg.state.width - 130, marginRight:10}], numberOfLines:0}, info.goods_name)));

pros = info.property;

for(var j=0; j < pros.length; j++) {
var pro=pros[j];
img = rowData.delg.get_spin(img, React.createElement(Text, {style:styles.yue_trade_detail_goods_desp}, pro.title, ':', pro.value));}}



if(rowData.order_sn){
img = rowData.delg.get_spin(img, React.createElement(Text, {style:styles.yue_trade_detail_goods_desp}, '订单编号:', rowData.order_sn));}


if(rowData.add_time){
img = rowData.delg.get_spin(img, React.createElement(Text, {style:styles.yue_trade_detail_goods_desp}, '下单时间:', rowData.add_time));}


if(rowData.pay_time){
img = rowData.delg.get_spin(img, React.createElement(Text, {style:styles.yue_trade_detail_goods_desp}, '支付时间:', rowData.pay_time));}


if(rowData.customer_service){
img = rowData.delg.get_spin(img, React.createElement(Text, {style:styles.yue_trade_detail_goods_desp}, '客服电话:', rowData.customer_service));}


return React.createElement(View, null, img);}


return React.createElement(View, {style:styles.yue_my_list_style});}}, {key:'render', value:
...
if(this.state.is_loading){
spin = 
React.createElement(View, {style:styles.centering}, 
React.createElement(ActivityIndicatorIOS, {
color:'#000', 
...
React.createElement(View, {style:[styles.yue_info_status, {height:this.state.status_height}]}), 
React.createElement(View, {style:styles.yue_info}, 
React.createElement(TouchableHighlight, {onPress:function(){return _this2.back();}, style:styles.yue_my_info_header_touch}, React.createElement(Image, {style:styles.yue_my_info_right, source:{uri:'https://ss2.baidu.com/6ONYsjip0QIZ8tyhnq/it/u=3088020551,4198140884&fm=96'}}))), 


React.createElement(View, {style:styles.yue_my_hr}), 
spin));}}]);return yue_sj_trade_detail;})(React.Component);





module.exports = yue_sj_trade_detail;});
__d('react-native/yueyue_src/yue_sj_button',["react-native/Libraries/react-native/react-native"],function(global, require, requireDynamic, requireLazy, module, exports) {  'use strict';var _createClass=(function(){function defineProperties(target, props){for(var i=0; i < props.length; i++) {var descriptor=props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if('value' in descriptor)descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}return function(Constructor, protoProps, staticProps){if(protoProps)defineProperties(Constructor.prototype, protoProps);if(staticProps)defineProperties(Constructor, staticProps);return Constructor;};})();var _get=function get(object, property, receiver){var desc=Object.getOwnPropertyDescriptor(object, property);if(desc === undefined){var parent=Object.getPrototypeOf(object);if(parent === null){return undefined;}else {return get(parent, property, receiver);}}else if('value' in desc){return desc.value;}else {var getter=desc.get;if(getter === undefined){return undefined;}return getter.call(receiver);}};function _classCallCheck(instance, Constructor){if(!(instance instanceof Constructor)){throw new TypeError('Cannot call a class as a function');}}function _inherits(subClass, superClass){if(typeof superClass !== 'function' && superClass !== null){throw new TypeError('Super expression must either be null or a function, not ' + typeof superClass);}subClass.prototype = Object.create(superClass && superClass.prototype, {constructor:{value:subClass, enumerable:false, writable:true, configurable:true}});if(superClass)subClass.__proto__ = superClass;}

var React=require('react-native/Libraries/react-native/react-native');var 


Component=
React.Component;var TouchableWithoutFeedback=React.TouchableWithoutFeedback;var Image=React.Image;var 

yue_sj_button=(function(_React$Component){
function yue_sj_button(props){_classCallCheck(this, yue_sj_button);
_get(Object.getPrototypeOf(yue_sj_button.prototype), 'constructor', this).call(this, props.buttonProps.normal);

this.state = {
onPress:props.onPress, 
subscription:{}, 
tag:props.buttonProps.tag, 
is_press:false, 
normal:props.buttonProps.normal, 
high:props.buttonProps.high, 
style:props.style};}_inherits(yue_sj_button, _React$Component);_createClass(yue_sj_button, [{key:'render', value:




function render(){var _this=this;
if(this.state.is_press){
return (
React.createElement(TouchableWithoutFeedback, {onPressOut:function(){return _this.setState({is_press:false});}, onPress:function(){return _this.state.onPress(_this.state.tag);}}, 
React.createElement(Image, {source:{uri:this.state.high}, style:this.state.style})));}else 


{
return (
React.createElement(TouchableWithoutFeedback, {onPressIn:function(){return _this.setState({is_press:true});}, onPress:function(){return _this.state.onPress(_this.state.tag);}}, 
React.createElement(Image, {source:{uri:this.state.normal}, style:this.state.style})));}}}]);return yue_sj_button;})(React.Component);
...
module.exports = yue_sj_button;});
__d('react-native/yueyue_src/yue_sj_base',["react-native/Libraries/react-native/react-native","react-native/yueyue_src/yue_hot_sj_trade","react-native/yueyue_src/yue_sj_my","react-native/Libraries/react-native/react-native"],function(global, require, requireDynamic, requireLazy, module, exports) {  'use strict';var _createClass=(function(){function defineProperties(target, props){for(var i=0; i < props.length; i++) {var descriptor=props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if('value' in descriptor)descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}return function(Constructor, protoProps, staticProps){if(protoProps)defineProperties(Constructor.prototype, protoProps);if(staticProps)defineProperties(Constructor, staticProps);return Constructor;};})();var _get=function get(object, property, receiver){var desc=Object.getOwnPropertyDescriptor(object, property);if(desc === undefined){var parent=Object.getPrototypeOf(object);if(parent === null){return undefined;}else {return get(parent, property, receiver);}}else if('value' in desc){return desc.value;}else {var getter=desc.get;if(getter === undefined){return undefined;}return getter.call(receiver);}};function _classCallCheck(instance, Constructor){if(!(instance instanceof Constructor)){throw new TypeError('Cannot call a class as a function');}}function _inherits(subClass, superClass){if(typeof superClass !== 'function' && superClass !== null){throw new TypeError('Super expression must either be null or a function, not ' + typeof superClass);}subClass.prototype = Object.create(superClass && superClass.prototype, {constructor:{value:subClass, enumerable:false, writable:true, configurable:true}});if(superClass)subClass.__proto__ = superClass;}

var React=require('react-native/Libraries/react-native/react-native');var 


Component=
React.Component;var View=React.View;var 

yue_sj_base=(function(_React$Component){
function yue_sj_base(props){_classCallCheck(this, yue_sj_base);
_get(Object.getPrototypeOf(yue_sj_base.prototype), 'constructor', this).call(this, props);

this.state = {
subscription:{}};}_inherits(yue_sj_base, _React$Component);_createClass(yue_sj_base, [{key:'trans_pid', value:



function trans_pid(t_pid){

if(t_pid == '1250001'){
var tyue_sj_trade=require('react-native/yueyue_src/yue_hot_sj_trade');

this.props.navigator.replace({
title:'', 
component:tyue_sj_trade, 
passProps:
this.props});}else 

if(t_pid == '1250002'){
var tyue_my_info=require('react-native/yueyue_src/yue_sj_my');
this.props.navigator.replace({
title:'', 
component:tyue_my_info, 
passProps:
this.props});}}}, {key:'componentWillMount', value:





function componentWillMount(){var _this=this;var _require=
require('react-native/Libraries/react-native/react-native');var DeviceEventEmitter=_require.DeviceEventEmitter;
this.state.subscription = DeviceEventEmitter.addListener('trans_pid', function(pid){return _this.trans_pid(pid);});}}, {key:'componentWillUnmount', value:


function componentWillUnmount(){
this.state.subscription.remove('trans_pid');}}, {key:'render', value:



function render(){
return (
React.createElement(View, null));}}]);return yue_sj_base;})(React.Component);





module.exports = yue_sj_base;});
__d('react-native/yueyue_src/yue_sj_my',["react-native/Libraries/react-native/react-native","react-native/yueyue_src/yue_sj_base","react-native/yueyue_src/yue_hot_sj_trade","react-native/yueyue_src/yue_sj_my_cover","react-native/yueyue_src/yue_sj_my_service","react-native/Libraries/react-native/react-native"],function(global, require, requireDynamic, requireLazy, module, exports) {  'use strict';var _createClass=(function(){function defineProperties(target, props){for(var i=0; i < props.length; i++) {var descriptor=props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if('value' in descriptor)descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}return function(Constructor, protoProps, staticProps){if(protoProps)defineProperties(Constructor.prototype, protoProps);if(staticProps)defineProperties(Constructor, staticProps);return Constructor;};})();var _get=function get(object, property, receiver){var desc=Object.getOwnPropertyDescriptor(object, property);if(desc === undefined){var parent=Object.getPrototypeOf(object);if(parent === null){return undefined;}else {return get(parent, property, receiver);}}else if('value' in desc){return desc.value;}else {var getter=desc.get;if(getter === undefined){return undefined;}return getter.call(receiver);}};function _classCallCheck(instance, Constructor){if(!(instance instanceof Constructor)){throw new TypeError('Cannot call a class as a function');}}function _inherits(subClass, superClass){if(typeof superClass !== 'function' && superClass !== null){throw new TypeError('Super expression must either be null or a function, not ' + typeof superClass);}subClass.prototype = Object.create(superClass && superClass.prototype, {constructor:{value:subClass, enumerable:false, writable:true, configurable:true}});if(superClass)subClass.__proto__ = superClass;}
...
yue_cover_list_right:{
flexDirection:'row', 
marginRight:10}, 

yue_cover_list_left_img:{
width:30, 
height:30, 
marginTop:10}, 

yue_cover_list_left_edit_img:{
width:80, 
height:80, 
marginTop:10, 
borderRadius:40}, 

yue_cover_list_left_edit_text:{
marginLeft:10, 
marginTop:30, 
height:50}, 

yue_cover_list_left_edit_inner_text:{
fontSize:20, 
lineHeight:20}, 

yue_cover_list_left_text:{
lineHeight:15, 
fontSize:15, 
marginTop:15, 
marginLeft:10}, 

yue_cover_list_right_img:{
width:30, 
height:30, 
marginTop:10, 
marginRight:10}});var 
...
yue_sj_my=(function(_React$Component){
function yue_sj_my(props){_classCallCheck(this, yue_sj_my);
_get(Object.getPrototypeOf(yue_sj_my.prototype), 'constructor', this).call(this, props);
StatusBarIOS.setStyle(0);
var ds=new ListView.DataSource({rowHasChanged:function(r1, r2){return r1 !== r2;}});
...
_result_info:{}, 
status_height:props.screen_info.status_height, 
dataSource:ds.cloneWithRows(this.get_row_info(props.screen_info.screen_width))};}_inherits(yue_sj_my, _React$Component);_createClass(yue_sj_my, [{key:'get_row_info', value:



function get_row_info(wid){
var info=[{type:'edit', icon:'', nick:'name', sub_nick:'sub_nick', height:100, width:wid, delg:this, idx:0}, 
{type:'row_normal', title:'我的服务', height:50, width:wid, delg:this, idx:1}, 
{type:'row_normal', title:'服务认证', height:50, width:wid, delg:this, idx:2}, 
{type:'row_normal', title:'我的评价', height:50, width:wid, delg:this, idx:3}, 
{type:'row_normal', title:'我的钱包', height:50, width:wid, delg:this, idx:4}, 
{type:'row_normal', title:'设置', height:50, width:wid, delg:this, idx:5}];
return info;}}, {key:'deal_qrcode', value:


function deal_qrcode(url){var _this=this;
this.unregister_notify('qrcode_success_react', function(url){return _this.deal_qrcode(url);});}}, {key:'show_qrcode', value:
...
{
NativeModules.yue_hot_react_call.login();}});}}, {key:'show_cover', value:





function show_cover(){var _this4=this;
NativeModules.yue_hot_react_call.is_login(null, function(isLogin){
if(isLogin){
var yue_hot_sj_trade=require('react-native/yueyue_src/yue_hot_sj_trade');
_this4.props.navigator.replace({
title:'', 
component:yue_hot_sj_trade, 
passProps:
_this4.props});}else 


{
NativeModules.yue_hot_react_call.login();}});}}, {key:'show_my_setting', value:
...
NativeModules.yue_hot_react_call.show_setting();}}, {key:'show_my_cover', value:


function show_my_cover(){
var my_cover=require('react-native/yueyue_src/yue_sj_my_cover');
this.props.navigator.push({title:'Results', component:my_cover, passProps:{'screen_info':this.props.screen_info}});}}, {key:'show_my_service', value:


function show_my_service(){
var my_service=require('react-native/yueyue_src/yue_sj_my_service');
this.props.navigator.push({title:'Results', component:my_service, passProps:{'screen_info':this.props.screen_info}});}}, {key:'register_notify', value:
...
function unregister_notify(notify, handler){
this.state.subscription.remove(notify);}}, {key:'componentWillMount', value:


function componentWillMount(){}}, {key:'componentWillUnmount', value:



function componentWillUnmount(){}}, {key:'renderRow', value:


function renderRow(rowData, sectionID, rowID){
if(rowData.type == 'edit'){
return (
React.createElement(TouchableHighlight, {onPress:function(){return rowData.delg.show_my_cover();}}, 
React.createElement(View, {style:[styles.yue_my_list, {height:rowData.height}]}, 
React.createElement(View, {style:styles.yue_cover_list_left}, 
React.createElement(Image, {style:styles.yue_cover_list_left_edit_img, source:{uri:'https://ss2.baidu.com/6ONYsjip0QIZ8tyhnq/it/u=3088020551,4198140884&fm=96'}}), 
React.createElement(View, {style:styles.yue_cover_list_left_edit_text}, 
React.createElement(Text, {style:styles.yue_cover_list_left_edit_inner_text}, rowData.nick), 
React.createElement(Text, {style:styles.yue_cover_list_left_edit_inner_text}, rowData.nick))), 


React.createElement(View, {style:styles.yue_cover_list_right}, 
React.createElement(Text, null, rowData.nick)))));}else 




if(rowData.type == 'row_normal'){
var spin=React.createElement(View, {style:[styles.yue_my_list, {height:rowData.height}]}, 
React.createElement(View, {style:styles.yue_cover_list_left}, 
React.createElement(Image, {style:styles.yue_cover_list_left_img, source:{uri:'https://ss2.baidu.com/6ONYsjip0QIZ8tyhnq/it/u=3088020551,4198140884&fm=96'}}), 
React.createElement(Text, {style:styles.yue_cover_list_left_text}, rowData.title)), 

React.createElement(Image, {style:styles.yue_cover_list_right_img, source:{uri:'https://ss2.baidu.com/6ONYsjip0QIZ8tyhnq/it/u=3088020551,4198140884&fm=96'}}));


if(rowData.idx == 1){
return (
React.createElement(TouchableHighlight, {onPress:function(){return rowData.delg.show_my_service();}}, 
spin));}else 


if(rowData.idx == 5){
return (
React.createElement(TouchableHighlight, {onPress:function(){return rowData.delg.show_my_setting();}}, 
spin));}else 


{
return (
React.createElement(TouchableHighlight, {onPress:function(){return alert('asdklfjhalskjdf');}}, 
spin));}}}}, {key:'render', value:
...
React.createElement(View, {style:styles.yue_info}, 
React.createElement(Text, {style:styles.yue_my_info_left}, '约约-商家版'), 
React.createElement(TouchableHighlight, {onPress:function(){return _this5.show_qrcode();}, style:styles.yue_my_info_header_touch}, React.createElement(Image, {style:styles.yue_my_info_right, source:{uri:'https://ss2.baidu.com/6ONYsjip0QIZ8tyhnq/it/u=3088020551,4198140884&fm=96'}}))), 


React.createElement(View, {style:styles.yue_my_hr}), 
spin, 
React.createElement(View, {style:styles.yue_my_info_bottom}, 
React.createElement(TouchableHighlight, {style:[styles.yue_my_info_bottom_left, {width:this.state.width}], onPress:function(){return _this5.show_message();}}, React.createElement(Text, {style:styles.yue_my_info_bottom_txt}, '消息')), 
React.createElement(TouchableHighlight, {style:[styles.yue_my_info_bottom_certer, {width:this.state.width}], onPress:function(){return _this5.show_cover();}}, React.createElement(Text, {style:styles.yue_my_info_bottom_txt}, '交易')), 
React.createElement(TouchableHighlight, {style:[styles.yue_my_info_bottom_right, {width:this.state.width}]}, React.createElement(Text, {style:styles.yue_my_info_bottom_txt}, '我的')))));}}]);return yue_sj_my;})(React.Component);
...
module.exports = yue_sj_my;});
__d('react-native/yueyue_src/yue_sj_my_cover',["react-native/Libraries/react-native/react-native","react-native/yueyue_src/yue_sj_my_intro"],function(global, require, requireDynamic, requireLazy, module, exports) {  'use strict';var _createClass=(function(){function defineProperties(target, props){for(var i=0; i < props.length; i++) {var descriptor=props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if('value' in descriptor)descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}return function(Constructor, protoProps, staticProps){if(protoProps)defineProperties(Constructor.prototype, protoProps);if(staticProps)defineProperties(Constructor, staticProps);return Constructor;};})();var _get=function get(object, property, receiver){var desc=Object.getOwnPropertyDescriptor(object, property);if(desc === undefined){var parent=Object.getPrototypeOf(object);if(parent === null){return undefined;}else {return get(parent, property, receiver);}}else if('value' in desc){return desc.value;}else {var getter=desc.get;if(getter === undefined){return undefined;}return getter.call(receiver);}};function _classCallCheck(instance, Constructor){if(!(instance instanceof Constructor)){throw new TypeError('Cannot call a class as a function');}}function _inherits(subClass, superClass){if(typeof superClass !== 'function' && superClass !== null){throw new TypeError('Super expression must either be null or a function, not ' + typeof superClass);}subClass.prototype = Object.create(superClass && superClass.prototype, {constructor:{value:subClass, enumerable:false, writable:true, configurable:true}});if(superClass)subClass.__proto__ = superClass;}
...
yue_cover_list_square:{
flexDirection:'row', 
flex:1, 
justifyContent:'space-around'}, 

yue_cover_list_label:{
flexDirection:'row', 
flex:1, 
marginLeft:10}, 

yue_cover_list_merit:{
flexDirection:'row', 
flex:1, 
marginLeft:10, 
marginTop:10}, 

yue_cover_list_trade:{
flexDirection:'row', 
flex:1, 
marginLeft:10, 
marginTop:5}});var 
...
yue_sj_my_cover=(function(_React$Component){
function yue_sj_my_cover(props){_classCallCheck(this, yue_sj_my_cover);
_get(Object.getPrototypeOf(yue_sj_my_cover.prototype), 'constructor', this).call(this, props);
var ds=new ListView.DataSource({rowHasChanged:function(r1, r2){return r1 !== r2;}});
...
this.load_data();}_inherits(yue_sj_my_cover, _React$Component);_createClass(yue_sj_my_cover, [{key:'load_data', value:


function load_data(){var _this=this;
NativeModules.yue_hot_react_call.request_hasId_by_url('http://yp.yueus.com/mobile_app/merchant/seller_index.php', 'http://yp-wifi.yueus.com/mobile_app/merchant/seller_index.php', {time_out:15, user_id:this.props.user_id}, function(info){
_this.deal_info(info);});}}, {key:'deal_info', value:
...
if(!info.ERROR_CODE && info.code == 200){
info = info.data;
var my_info_array=[], my_pro=['bgpic', 'avatar', 'name', 'sex', 'introduce', 'detail', 'location', 'user_id'];
var my_info={}, my_property=info.property, bus=info.business, showcase=info.showcase;
var i;

for(i = 0; i < my_pro.length; i++) {
var pro=info[my_pro[i]];

my_info[my_pro[i]] = pro;}


my_info.type = 'person_property';
my_info.delg = this;
my_info_array[my_info_array.length] = my_info;

if(my_property){
for(var key in my_property) {
var pro=my_property[key], display={};
display.display = key;
display.delg = this;
display.type = 'property';
display.data = pro;
my_info_array[my_info_array.length] = display;}}
...
var bussiness={};
bussiness.data = bus;
bussiness.type = 'bussiness';
bussiness.delg = this;
my_info_array[my_info_array.length] = bussiness;}
...
show.delg = this;
show.type = 'showcase';
my_info_array[my_info_array.length] = show;}}



var ds=new ListView.DataSource({rowHasChanged:function(r1, r2){return r1 !== r2;}});
this.setState({_result_info:info, is_loading:false, dataSource:ds.cloneWithRows(my_info_array)});}else 
{
this.setState({_result_info:info, is_loading:false});}}}, {key:'back', value:
...
this.props.navigator.pop();else 
{
NativeModules.yue_hot_react_call.go_back_nav();}}}, {key:'get_model_property_view', value:



function get_model_property_view(info, root){
if(info.type == 'round'){
var val_info={'m_bwh':'三围', 'm_cups':'罩杯', 'm_height':'身高', 'm_weight':'体重'};
var bwh=info.value.m_bwh?React.createElement(View, {style:{alignItems:'center'}}, React.createElement(Image, {source:{uri:'https://ss2.baidu.com/6ONYsjip0QIZ8tyhnq/it/u=3088020551,4198140884&fm=96'}, style:{marginTop:10, width:40, height:40}}), React.createElement(Text, null, info.value.m_bwh)):null;
var m_cups=info.value.m_cups?React.createElement(View, {style:{alignItems:'center'}}, React.createElement(Image, {source:{uri:'https://ss2.baidu.com/6ONYsjip0QIZ8tyhnq/it/u=3088020551,4198140884&fm=96'}, style:{marginTop:10, width:40, height:40}}), React.createElement(Text, null, info.value.m_cups)):null;
var m_height=info.value.m_height?React.createElement(View, {style:{alignItems:'center'}}, React.createElement(Image, {source:{uri:'https://ss2.baidu.com/6ONYsjip0QIZ8tyhnq/it/u=3088020551,4198140884&fm=96'}, style:{marginTop:10, width:40, height:40}}), React.createElement(Text, null, info.value.m_height)):null;
var m_weight=info.value.m_weight?React.createElement(View, {style:{alignItems:'center'}}, React.createElement(Image, {source:{uri:'https://ss2.baidu.com/6ONYsjip0QIZ8tyhnq/it/u=3088020551,4198140884&fm=96'}, style:{marginTop:10, width:40, height:40}}), React.createElement(Text, null, info.value.m_weight)):null;
return React.createElement(View, {style:styles.yue_my_list_style}, 
React.createElement(Text, {style:{textAlign:'center', height:14, fontSize:14, marginLeft:0}}, info.title), 
React.createElement(View, {style:{flex:1, flexDirection:'row', justifyContent:'space-around'}}, 
bwh, 
m_cups, 
m_height, 
m_weight));}else 
...
if(info.type == 'squared'){
if(info.title && info.value){
return React.createElement(View, {style:styles.yue_cover_list_square}, 
React.createElement(Text, {style:{textAlign:'left', height:14, marginTop:13, fontSize:14}}, info.title), 
React.createElement(Text, {style:{textAlign:'left', height:14, marginTop:13, fontSize:14}}, 'V', info.value, '实名认证'));}}else 


if(info.type == 'label'){
if(info.title && info.value){
return React.createElement(View, {style:styles.yue_cover_list_label}, 
React.createElement(Text, {style:{textAlign:'left', height:14, marginTop:8, fontSize:14, marginLeft:10}}, info.title, ':', info.value));}}else 


if(info.type == 'merit'){
var img=null;

for(var i=0; i < info.value / 2; i++) {
img = root.get_row_spin(img, React.createElement(Image, {source:{uri:'https://ss2.baidu.com/6ONYsjip0QIZ8tyhnq/it/u=3088020551,4198140884&fm=96'}, style:{marginLeft:10, width:20, height:20}}));}


return React.createElement(View, {style:styles.yue_cover_list_merit}, React.createElement(Text, null, info.title, ':'), img);}else 
if(info.type == 'totaltrade' && info.title && info.value){
return React.createElement(View, {style:styles.yue_cover_list_trade}, React.createElement(Text, null, info.title, ':(', info.value, ')'));}}}, {key:'get_row_spin', value:



function get_row_spin(spin, another_spin){
return React.createElement(View, {style:{flexDirection:'row'}}, spin, another_spin);}}, {key:'get_spin', value:


function get_spin(spin, another_spin){
return React.createElement(View, null, spin, another_spin);}}, {key:'show_detail', value:


function show_detail(user_id){
var img=['img1', 'img2', 'img1', 'img2', 'img1', 'img2', 'img1', 'img2', 'img1', 'img2', 'img1', 'img2'];

for(var i=0; i < 10; i++) {
React.createElement(View, null, 
React.createElement(Image, {source:{uri:img[i]}}));}
...
if(user_id){
if(user_id.length){
var my_intro=require('react-native/yueyue_src/yue_sj_my_intro');
this.props.navigator.push({title:'Results', component:my_intro, passProps:{'screen_info':this.props.screen_info, data:user_id}});}}}}, {key:'renderRow', value:
...
if(type == 'person_property'){
return React.createElement(View, {style:[styles.yue_my_list_style, {backgroundColor:'#fff'}]}, 
React.createElement(Image, {source:{uri:rowData.bgpic}, style:{width:rowData.delg.state.width, height:rowData.delg.state.width * 0.453, backgroundColor:'#565'}}), 
React.createElement(Image, {source:{uri:rowData.avatar}, style:{borderRadius:20, marginTop:-20, width:40, height:40, marginLeft:rowData.delg.state.width * 0.5 - 20}}), 
React.createElement(Text, {style:{width:rowData.delg.state.width, textAlign:'center', height:16, fontSize:16, marginTop:12}}, rowData.name), 
React.createElement(Text, {style:{width:rowData.delg.state.width, textAlign:'center', height:14, fontSize:14, marginTop:20}}, '个人简介'), 
React.createElement(Text, {style:{width:rowData.delg.state.width - 20, textAlign:'left', fontSize:14, marginTop:10, marginLeft:10}}, rowData.introduce), 
React.createElement(TouchableHighlight, {onPress:function(){return rowData.delg.show_detail(rowData.user_id);}, style:{flex:1, alignItems:'center'}}, React.createElement(Image, {source:{uri:'https://ss2.baidu.com/6ONYsjip0QIZ8tyhnq/it/u=3088020551,4198140884&fm=96'}, style:{marginTop:10, width:40, height:40}})), 
React.createElement(Text, {style:{width:rowData.delg.state.width, textAlign:'left', height:16, fontSize:16, marginTop:12, marginLeft:10}}, '城市:', rowData.location), 
React.createElement(View, {style:{height:1, backgroundColor:'#eee', marginTop:10}}));}else 

if(type == 'property'){
var display_type=rowData.display;
if(display_type == 'model'){
var spin=null;
for(var key in rowData.data) {
spin = rowData.delg.get_spin(spin, rowData.delg.get_model_property_view(rowData.data[key], rowData.delg));}


return React.createElement(View, {style:styles.yue_my_list_style}, 
React.createElement(Text, {style:{width:rowData.delg.state.width, textAlign:'center', height:14, fontSize:14, marginTop:20}}, '模特服务'), 
spin, 
React.createElement(View, {style:{height:1, backgroundColor:'#eee', marginTop:10}}));}else 

if(display_type == 'photography'){
var spin=rowData.delg.get_spin(null);
for(var i=0; i < rowData.data.length; i++) {
var info=rowData.data[i];
spin = rowData.delg.get_spin(spin, rowData.delg.get_model_property_view(info, rowData.delg));}

return React.createElement(View, {style:styles.yue_my_list_style}, 
React.createElement(Text, {style:{width:rowData.delg.state.width, textAlign:'center', height:14, fontSize:14, marginTop:20}}, '摄影服务'), 
spin, 
React.createElement(View, {style:{height:1, backgroundColor:'#eee', marginTop:10}}));}}else 
...
if(type == 'bussiness'){
var spin=null;
var t_data=rowData.data;
var t_key=['merit', 'totaltrade'];
for(var i=0; i < 2; i++) {
var key=t_key[i];
var info=t_data[key];
info.type = key;
...
return React.createElement(View, {style:styles.yue_my_list_style}, 
React.createElement(Image, {source:{uri:rowData.pic}, style:{width:rowData.delg.state.width, height:90, marginTop:10}}));}
...
React.createElement(View, {style:styles.yue_my_hr}), 
spin));}}]);return yue_sj_my_cover;})(React.Component);





module.exports = yue_sj_my_cover;});
__d('react-native/yueyue_src/yue_sj_my_intro',["react-native/Libraries/react-native/react-native"],function(global, require, requireDynamic, requireLazy, module, exports) {  'use strict';var _createClass=(function(){function defineProperties(target, props){for(var i=0; i < props.length; i++) {var descriptor=props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if('value' in descriptor)descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}return function(Constructor, protoProps, staticProps){if(protoProps)defineProperties(Constructor.prototype, protoProps);if(staticProps)defineProperties(Constructor, staticProps);return Constructor;};})();var _get=function get(object, property, receiver){var desc=Object.getOwnPropertyDescriptor(object, property);if(desc === undefined){var parent=Object.getPrototypeOf(object);if(parent === null){return undefined;}else {return get(parent, property, receiver);}}else if('value' in desc){return desc.value;}else {var getter=desc.get;if(getter === undefined){return undefined;}return getter.call(receiver);}};function _classCallCheck(instance, Constructor){if(!(instance instanceof Constructor)){throw new TypeError('Cannot call a class as a function');}}function _inherits(subClass, superClass){if(typeof superClass !== 'function' && superClass !== null){throw new TypeError('Super expression must either be null or a function, not ' + typeof superClass);}subClass.prototype = Object.create(superClass && superClass.prototype, {constructor:{value:subClass, enumerable:false, writable:true, configurable:true}});if(superClass)subClass.__proto__ = superClass;}
...
yue_sj_my_intro=(function(_React$Component){
function yue_sj_my_intro(props){_classCallCheck(this, yue_sj_my_intro);
_get(Object.getPrototypeOf(yue_sj_my_intro.prototype), 'constructor', this).call(this, props);
var ds=new ListView.DataSource({rowHasChanged:function(r1, r2){return r1 !== r2;}});
...
this.load_data();}_inherits(yue_sj_my_intro, _React$Component);_createClass(yue_sj_my_intro, [{key:'load_data', value:
...
NativeModules.yue_hot_react_call.request_hasId_by_url('http://yp.yueus.com/mobile_app/merchant/seller_index_detail.php', 'http://yp-wifi.yueus.com/mobile_app/merchant/seller_index_detail.php', {time_out:15, user_id:this.props.data}, function(info){
_this.deal_info(info);});}}, {key:'deal_info', value:



function deal_info(info){var _this2=this;
if(!info.ERROR_CODE){
if(info.code == 200){
var data=info.data;
if(data){
if(data.introduce){
NativeModules.yue_hot_react_call.deal_text(data.introduce, function(info){
var ds=new ListView.DataSource({rowHasChanged:function(r1, r2){return r1 !== r2;}});
for(var i=0; i < info.length; i++) {
for(var j=0; j < info[i].length; j++) {
var txt_info=info[i][j];
txt_info.delg = _this2;}}



_this2.setState({dataSource:ds.cloneWithRows(info), is_loading:false});});
...
this.setState({is_loading:false});}else 
{
this.setState({is_loading:false, error_msg:info.ERROR_MSG});}}}, {key:'back', value:
...
this.props.navigator.pop();else 
{
NativeModules.yue_hot_react_call.go_back_nav();}}}, {key:'get_text_spin', value:



function get_text_spin(spin, another_spin){
return React.createElement(Text, null, spin, another_spin);}}, {key:'renderRow', value:


function renderRow(rowData, sectionID, rowID){
var t_spin=null, react_style, delg;
var img=false;
console.log(rowData);
...
if(i == 0){
delg = info.delg;
react_style = info.react_style;}

if(info.type == 'img'){
img = true;
t_spin = React.createElement(Image, {source:{uri:info.img}, style:info.react_style});
break;}else 
{
if(info.event){
t_spin = info.delg.get_text_spin(t_spin, React.createElement(Text, {style:info.react_style, onPress:function(){return alert(info.event);}}, rowData[i].txt));}else 
{
t_spin = info.delg.get_text_spin(t_spin, React.createElement(Text, {style:info.react_style}, rowData[i].txt));}}}




if(img){
return React.createElement(View, {style:{flex:1, alignItems:'center', marginTop:5, marginBottom:5}}, t_spin);}else 

return React.createElement(Text, {style:[react_style, {width:delg.width, numberOfLines:0}], numberOfLines:0}, t_spin);}}, {key:'render', value:
...
{
if(this.state.error_msg){
spin = React.createElement(Text, {style:{lineHeight:this.state.height - this.state.status_height - 49}}, 'this.state.error_msg');}else 
{
spin = 
React.createElement(View, {style:styles.yue_my_list_style}, 
React.createElement(ListView, {
...
React.createElement(View, {style:[styles.yue_info_status, {height:this.state.status_height}]}), 
React.createElement(View, {style:styles.yue_info}, 
React.createElement(TouchableHighlight, {onPress:function(){return _this3.back();}, style:styles.yue_my_info_header_touch}, React.createElement(Image, {style:styles.yue_my_info_right, source:{uri:'https://ss2.baidu.com/6ONYsjip0QIZ8tyhnq/it/u=3088020551,4198140884&fm=96'}}))), 


React.createElement(View, {style:styles.yue_my_hr}), 
spin));}}]);return yue_sj_my_intro;})(React.Component);
...
module.exports = yue_sj_my_intro;});
__d('react-native/yueyue_src/yue_sj_my_service',["react-native/Libraries/react-native/react-native","react-native/yueyue_src/yueyueMyService"],function(global, require, requireDynamic, requireLazy, module, exports) {  'use strict';var _createClass=(function(){function defineProperties(target, props){for(var i=0; i < props.length; i++) {var descriptor=props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if('value' in descriptor)descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}return function(Constructor, protoProps, staticProps){if(protoProps)defineProperties(Constructor.prototype, protoProps);if(staticProps)defineProperties(Constructor, staticProps);return Constructor;};})();var _get=function get(object, property, receiver){var desc=Object.getOwnPropertyDescriptor(object, property);if(desc === undefined){var parent=Object.getPrototypeOf(object);if(parent === null){return undefined;}else {return get(parent, property, receiver);}}else if('value' in desc){return desc.value;}else {var getter=desc.get;if(getter === undefined){return undefined;}return getter.call(receiver);}};function _classCallCheck(instance, Constructor){if(!(instance instanceof Constructor)){throw new TypeError('Cannot call a class as a function');}}function _inherits(subClass, superClass){if(typeof superClass !== 'function' && superClass !== null){throw new TypeError('Super expression must either be null or a function, not ' + typeof superClass);}subClass.prototype = Object.create(superClass && superClass.prototype, {constructor:{value:subClass, enumerable:false, writable:true, configurable:true}});if(superClass)subClass.__proto__ = superClass;}
...
yue_sj_my_service=(function(_React$Component){
function yue_sj_my_service(props){_classCallCheck(this, yue_sj_my_service);
_get(Object.getPrototypeOf(yue_sj_my_service.prototype), 'constructor', this).call(this, props);
...
this.load_data('on_sell');}_inherits(yue_sj_my_service, _React$Component);_createClass(yue_sj_my_service, [{key:'load_data', value:


function load_data(sell_type){var _this=this;
if(this.state.sell_data[sell_type]){
var ds=new ListView.DataSource({rowHasChanged:function(r1, r2){return r1 !== r2;}});
this.setState({is_loading:false, dataSource:ds.cloneWithRows(this.state.sell_data[sell_type])});}else 

NativeModules.yue_hot_react_call.request_hasId_by_url('http://yp.yueus.com/mobile_app/merchant/sell_services_list.php', 'http://yp-wifi.yueus.com/mobile_app/merchant/sell_services_list.php', {time_out:15, service_status:sell_type, goods_type:'all', keyword:'', page:1, limit:20, user_id:this.state.user_id}, function(info){
_this.deal_info(info, sell_type);});}}, {key:'deal_info', value:



function deal_info(info, sell_type){
if(!info.ERROR_CODE){
if(info.code == 200){
var data=info.data;
if(data.list){
for(var i=0; i < data.list.length; i++) {
data.list[i].delg = this;}


this.state.sell_data[sell_type] = data.list;
var ds=new ListView.DataSource({rowHasChanged:function(r1, r2){return r1 !== r2;}});
this.setState({is_loading:false, dataSource:ds.cloneWithRows(data.list)});}}
...
this.props.navigator.pop();else 
{
NativeModules.yue_hot_react_call.go_back_nav();}}}, {key:'show_next', value:



function show_next(url){var _this2=this;
var param=['goods_id', 'user_id'];
NativeModules.yue_hot_react_call.get_url_val_by_param(param, url, function(call_back){
var trade_detail=require('react-native/yueyue_src/yueyueMyService');
_this2.props.navigator.push({title:'', component:trade_detail, passProps:{data:call_back, screen_info:_this2.props.screen_info}});});}}, {key:'renderRow', value:



function renderRow(rowData, sectionID, rowID){
return React.createElement(TouchableHighlight, {onPress:function(){return rowData.delg.show_next(rowData.link);}}, React.createElement(View, {style:{flex:1, flexDirection:'row', backgroundColor:'#fff'}}, 
React.createElement(Image, {source:{uri:rowData.images}, style:{width:100, height:100, marginLeft:10, marginTop:5, marginBottom:5, marginRight:20}}), 
React.createElement(View, {style:{alignSelf:'center'}}, 
React.createElement(Text, null, rowData.titles), 
React.createElement(Text, null, rowData.prices)), 
...
React.createElement(View, {style:styles.yue_my_hr}), 
React.createElement(View, {style:{flexDirection:'row', justifyContent:'space-around', height:40, alignItems:'center'}}, 
React.createElement(Text, {onPress:function(){return _this3.load_data('on_sell');}}, '在售服务'), 
React.createElement(Text, {onPress:function(){return _this3.load_data('off_sell');}}, '下架服务')), 

React.createElement(View, {style:{height:1, backgroundColor:'#eee'}}), 
spin));}}]);return yue_sj_my_service;})(React.Component);





module.exports = yue_sj_my_service;});
__d('react-native/yueyue_src/yueyueMyService',["react-native/Libraries/react-native/react-native","Dimensions","react-native/yueyue_src/YYFetch.ios"],function(global, require, requireDynamic, requireLazy, module, exports) {  'use strict';var _createClass=(function(){function defineProperties(target, props){for(var i=0; i < props.length; i++) {var descriptor=props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if('value' in descriptor)descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}return function(Constructor, protoProps, staticProps){if(protoProps)defineProperties(Constructor.prototype, protoProps);if(staticProps)defineProperties(Constructor, staticProps);return Constructor;};})();var _get=function get(object, property, receiver){var desc=Object.getOwnPropertyDescriptor(object, property);if(desc === undefined){var parent=Object.getPrototypeOf(object);if(parent === null){return undefined;}else {return get(parent, property, receiver);}}else if('value' in desc){return desc.value;}else {var getter=desc.get;if(getter === undefined){return undefined;}return getter.call(receiver);}};function _classCallCheck(instance, Constructor){if(!(instance instanceof Constructor)){throw new TypeError('Cannot call a class as a function');}}function _inherits(subClass, superClass){if(typeof superClass !== 'function' && superClass !== null){throw new TypeError('Super expression must either be null or a function, not ' + typeof superClass);}subClass.prototype = Object.create(superClass && superClass.prototype, {constructor:{value:subClass, enumerable:false, writable:true, configurable:true}});if(superClass)subClass.__proto__ = superClass;}
...
React.AppRegistry;var StyleSheet=React.StyleSheet;var ScrollView=React.ScrollView;var NativeModules=React.NativeModules;var Text=React.Text;var View=React.View;

var Dimensions=require('Dimensions');
var YYFetch=require('react-native/yueyue_src/YYFetch.ios');


var width=Dimensions.get('window').width;
var height=Dimensions.get('window').height;var 




yueyueMyServiceDesign=(function(_React$Component){

function yueyueMyServiceDesign(props){_classCallCheck(this, yueyueMyServiceDesign);
_get(Object.getPrototypeOf(yueyueMyServiceDesign.prototype), 'constructor', this).call(this, props);
this.state = this.getInitialState();}_inherits(yueyueMyServiceDesign, _React$Component);_createClass(yueyueMyServiceDesign, [{key:'getInitialState', value:


function getInitialState(){
return {

requestAllInfo:null};}}, {key:'getInfo', value:
...
var paramArray=['query'];
var dic=NativeModules.yue_hot_react_call.get_url_val_by_param(
paramArray, this.props.yueURL, function(callbackInfo){

var paramDic={'goods_id':'68'};

YYFetch.YYFetchWithToken('http://yp.yueus.com', '/mobile_app/merchant/sell_services.php', paramDic).
then(function(info){
...
console.warn('error:' + error);});});}}, {key:'componentDidMount', value:
...
this.getInfo();}}, {key:'render', value:


function render(){

var tmpFigureBar=null, data=null;

if(this.state.requestAllInfo){
data = JSON.stringify(this.state.requestAllInfo);}
...
React.createElement(View, {style:[styles.viewStyles, {flexDirection:'column'}]}, 
React.createElement(Text, {style:{fontSize:16, color:'#828282'}}, '性感摄影（可自带化妆，服装等服务）'), 
React.createElement(View, {style:{flexDirection:'row'}}, 
React.createElement(Text, {style:styles.discount}, '￥1000.00 - 3580.00'), 
React.createElement(View, null, 
React.createElement(Text, {style:styles.price}, '￥3000 - 8680'), 
React.createElement(View, {style:[styles.lineStyle, {marginTop:-7, marginLeft:10, width:width - 300, opacity:1}]}))))), 
...
React.createElement(View, {style:[styles.viewStyles, {flexDirection:'row', padding:15}]}, 
React.createElement(Text, {style:styles.serviceComTextStyle}, '选择 时间 属性分类')), 


React.createElement(View, {style:styles.lineStyle}), 


React.createElement(View, {style:styles.serviceCom}, 
React.createElement(Text, {style:styles.serviceComTextStyle}, '服务内容：'), 
React.createElement(View, {style:{flexDirection:'row', padding:10}}, 
React.createElement(Text, {style:styles.serviceComTextStyle}, '     风格'), 
React.createElement(Text, {style:[styles.serviceComTextStyle, {color:'#FFB6C1'}]}, '性感')), 

React.createElement(View, {style:{flexDirection:'row'}}, 
React.createElement(Text, {style:styles.serviceComTextStyle}, '摄影人数'), 
React.createElement(Text, {style:[styles.serviceComTextStyle, {color:'#FFB6C1'}]}, '1-3人'))), 
...
React.createElement(Text, {style:styles.centerFont}, '更多选项'))), 



React.createElement(View, {style:styles.menu}, 
React.createElement(View, {style:{margin:15}}, 
React.createElement(Text, {style:styles.centerFont}, '评价'), 
React.createElement(Text, {style:styles.centerFont}, '评价'), 

React.createElement(View, {style:[styles.transaction, {flexDirection:'row', margin:10}]}, 
React.createElement(Text, {style:[styles.centerFont, {color:'#FFB6C1', paddingLeft:5}]}, '交易次数  1168')))), 
...
React.createElement(View, {style:styles.menu}, 
React.createElement(View, {style:{margin:20}}, 
React.createElement(View, {style:{margin:20}}, 
React.createElement(View, {style:styles.imageStyle}), 


React.createElement(Text, {style:styles.centerFont}, '王梦实'), 
React.createElement(Text, {style:styles.centerFont}, 'ID：10086'), 

React.createElement(Text, {style:[styles.centerFont, {color:'#FFB6C1'}]}, '个人主页'))), 



React.createElement(View, {style:[styles.lineStyle, {width:width - 40}]}), 


React.createElement(View, {style:{margin:20}}, 
React.createElement(View, {style:{margin:10}}, 
React.createElement(Text, {style:styles.centerFont}, '身材'), 
React.createElement(View, {style:{flexDirection:'row', paddingLeft:10, paddingRight:10}}, 
React.createElement(View, {style:styles.figureStyle}), 
...
React.createElement(View, {style:{marginLeft:20, marginRight:20, flexDirection:'row'}}, 
React.createElement(Text, {style:styles.centerFont}, '170CM'), 
React.createElement(Text, {style:styles.centerFont}, '46KG'), 
React.createElement(Text, {style:styles.centerFont}, '88C'), 
React.createElement(Text, {style:styles.centerFont}, '86-60-90')), 


React.createElement(Text, {style:styles.centerFont}, '信用等级要求'), 
React.createElement(Text, {style:styles.centerFont}, 'V2实名认证')))), 
...
React.createElement(View, {style:{flexDirection:'row', height:50}}, 

React.createElement(Text, {style:styles.button}, '立即下单'), 
React.createElement(Text, {style:styles.button}, '查询'))));}}]);return yueyueMyServiceDesign;})(React.Component);
...
module.exports = yueyueMyServiceDesign;});
__d('react-native/yueyue_src/YYFetch.ios',["react-native/Libraries/react-native/react-native","react-native/yueyue_src/networkUtil.ios"],function(global, require, requireDynamic, requireLazy, module, exports) {  'use strict';
var React=require('react-native/Libraries/react-native/react-native');
var networkUtil=require('react-native/yueyue_src/networkUtil.ios');var 

NativeModules=
React.NativeModules;

var yue_react_util=NativeModules.yue_react_util;
var self={};
(function(){
...
self.YYFetchWithToken = function(domainurl, subfiexurl, parmaDic){
return new Promise(function(resolve, reject){
yue_react_util.getNetreqInfo(function(reqInfo){
if(reqInfo.userId && reqInfo.accessToken){
var url=window.g_getDomainByIsWifi(domainurl, reqInfo.isWifiEnable) + subfiexurl;
parmaDic.user_id = reqInfo.userId;
parmaDic.access_token = reqInfo.accessToken;
parmaDic.location_id = reqInfo.location_id;
var tmpjson=JSON.stringify(parmaDic);
yue_react_util.getMd5CodeFromJson(tmpjson, function(md5code){

var unixtimest=Date.parse(new Date()) / 1000;
var json_post=JSON.stringify({
version:reqInfo.appVersion, 
reactiveversion:window.g_reactivejsVersion, 
os_type:'ios', 
ctime:unixtimest, 
...
formdata.append('req', json_post);
fetch(url, {'timeoutInterval':'15.0', method:'post', body:formdata}).
then(function(response){
if(!response.ok){
reject(new TypeError('http request fail!'));}
...
reject(new TypeError('YYFetch exception' + error));});});}else 


{
reject(new TypeError('Not Login in'));}});});};





self.YYFetchWithOutToken = function(domainurl, subfiexurl, parmaDic){
return new Promise(function(resolve, reject){
yue_react_util.getNetreqInfo(function(reqInfo){
...
reject(new TypeError('YYFetch exception' + error));});});});});};
...
self.YYFetchWithToken.polyfill = true;
self.YYFetchWithOutToken.polyfill = true;})();

module.exports = self;});
__d('react-native/yueyue_src/networkUtil.ios',["react-native/Libraries/react-native/react-native"],function(global, require, requireDynamic, requireLazy, module, exports) {  'use strict';
var self={};
var React=require('react-native/Libraries/react-native/react-native');var 
...
React.NativeModules;
var yue_react_util=NativeModules.yue_react_util;
window.g_reactivejsVersion = '2.3.0.5';

window.g_getDomainByIsWifi = function(domainUrl, isWifiEnable){
var wifiMap={};
wifiMap['http://yp.yueus.com'] = 'http://yp-wifi.yueus.com';
if(isWifiEnable){
return wifiMap[domainUrl];}else 
{
return domainUrl;}};
...
var RCTMessage=requireNativeComponent('RCTMessage', Message);

module.exports = Message;});
;require("react-native/yueyue_src/index.ios");
//@ sourceMappingURL=/yueyue_src/index.ios.map