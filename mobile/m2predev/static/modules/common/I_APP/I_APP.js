...
else if(ua.is_yueseller_app)
{
	// app 跳转协议
	var app_protocol = 'yueseller://goto';
}
else
{
	isPaiApp = false;
...
var App = {
	...
	nav_to_app_page : function(params)
	{
		...
		{
			case 'model_card' :
				var pid = global_config.analysis_page.model_card.pid;
				break;
			case 'cameraman_card':
				var pid = global_config.analysis_page.cameraman_card.pid;
				break;
		}
