...
define(function(require, exports, module)
{
    ...
    ({
        ...
        events :
        {
            ...
            'tap [data-role="test-tap"]' : function(ev)
            {
            ...
            .on('success:reg',function(response,options)
            {
                ...
                if(code == 1)
                {
                    ...
                    var params =
                    {
                        ...
                        token : user_info.app_access_token,
                        token_expirein : user_info.app_expire_time,
                        role : utility.user.get('role')
                    };

                    console.log('========注册调用App login 参数========');
                    console.log(params);
