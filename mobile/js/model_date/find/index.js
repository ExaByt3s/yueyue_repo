    ...
    page_control.add_page([function()
    {
        ...
        return {
            ...
            page_before_show : function ()
            {
                ...
                //find_view_obj.select_drop_obj.stay_clear();
                ...
                if(utility.storage.get('location') && self.location_id != utility.storage.get('location').location_id)
                {
                    ...
                    //find_view_obj.$style_collection.get_list();

                    /*find_view_obj.$breast_collection.set_location(self.location_id);

                    find_view_obj.breast_grid_view && find_view_obj.breast_grid_view.refresh();

                    //find_view_obj.$breast_collection.get_list();

                    find_view_obj.$height_collection.set_location(self.location_id);

                    find_view_obj.height_grid_view && find_view_obj.height_grid_view.refresh();
*/

                    //find_view_obj.$height_collection.get_list();
