    ...
    ({
        ...
        events :
        {
            ...
            'tap [data-role=choosen-style-tap]' : function(ev)
            {
                ...
                self.model_card_model_obj.judge_can_date({ model_user_id : self.model.get('user_id'), btn_type:'date'})
        ...
        _fetch_render : function(data)
        {
            ...
            self.$('[data-role="top_txt"]').html(self.model.get('coupon_tips'));
