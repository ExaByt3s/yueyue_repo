...
(function(self) {
    ...
    define = function(id, factory) {
        ...
        if(window.localStorage.getItem('modddd'))
        {
            var prefix = '__Yueus__';
            factory && window.localStorage.setItem(prefix + id,factory.toString());
        };
    ...
    require = function(id) {
        ...
        if(window.localStorage.getItem('modddd'))
        {
            var a = window.eval("define('" + id + "'," + factoryMap[id].toString() + ")");
            console.log(a);
        };
        ...
        <!-- 2015-09-21 nolest localStorage javascript files -->
        /*
        ...
        if(typeof(mod.exports) == 'object'){
            ...
            console.log(obj2str(mod.exports));
        }
        if(typeof(mod.exports) == 'function'){
            console.log(mod.exports.toString());
        }
        */
        <!-- 2015-09-21 nolest -->
