...
<div id="header" class="header">
	<div class="logo">
		<a href="http://www.yueus.com" target="_blank"><img src="../resources/images/admin_logo.gif" width="180"></a>
	</div>
	...
	<?php
		...
		$nickname = $organization_obj->get_org_name_by_user_id($yue_login_id);
		echo $nickname;
	?>	<i>|</i><a href="logout.php">[退出]</a> </div>
	<div class="topmenu" id="top_tag">
		<ul>
			<li><span id="top_menu_1" class="current"><a href="#this">机构模特</a></span></li>
			<li><span id="top_menu_2"><a href="#this">修改密码</a></span></li>
		</ul>
	</div>
