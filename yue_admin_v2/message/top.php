...
<div id="header" class="header">
    <div class="logo">
        <a href="http://www.poco.cn" target="_blank"><img src="../resources/images/message_logo.gif" width="180"></a>
    </div>
    ...
    <div class="topmenu" id="top_tag">
        <ul>
            <?php echo create_auth_nav($yue_login_id,'MessageTop');?>
        </ul>
    </div>
    <div class="header_footer"></div>
</div>
<script>
    switch_tab2('top_tag','top_menu_','nav_','current',999);
</script>
<!--header-->
<style type="text/css">
    #leftMenu dd i
...
<div id="Main_content">
    <div id="MainBox">
        <div class="main_box">
            <iframe name="main" id="Main" src="main.php" frameborder="false" scrolling="hidden" width="100%" allowtransparency="true" height="700"></iframe>
        </div>
    </div>
    <div id="leftMenuBox">
        <div id="leftMenu" style="height: 231px; display: block;">
            <div style="padding-left:12px;_padding-left:10px;">
                <?php echo create_auth_nav($yue_login_id,'messageTop','left');?>
            </div>
        </div>
        <div id="Main_drop">
