...
<div id="header" class="header">
	<div class="logo">
		<a href="http://www.poco.cn" target="_blank"><img src="../resources/images/rank_logo.gif" width="180"></a>
	</div>
	...
	<div class="topmenu" id="top_tag">
		<ul>
			<?php echo create_auth_nav($yue_login_id,'rankTop');?>
		</ul>
	</div>
    ...
    <div id="leftMenuBox">
        <div id="leftMenu" style="height: 231px; display: block;">
            <div style="padding-left:12px;_padding-left:10px;">
                <?php echo create_auth_nav($yue_login_id,'rankTop','left');?>
            </div>
        </div>
        <div id="Main_drop">
