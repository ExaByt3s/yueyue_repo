...
check_auth($yue_login_id,'operate_month_list');//权限控制
...
//获取所有管理者到筛选者显示
$operator_arr = $report_operator_obj->get_operator_list_by_month(false,$month,0,$where_str,'GROUP BY operator_id','operator_id DESC','0,99999999',"operator_id");
...
if($operator_id >0)
{
    $setParam['operator_id'] = $operator_id;
}
