...
$tpl = new SmartTemplate( AUDIT_TEMPLATES_ROOT.'text_pass_examine_list.tpl.htm' );
...
$total_count = $text_examine_v2_obj->get_text_pass_list(true,$date,$type,$audit_id,$user_id,$where_str);
$page_obj->set($show_page,$total_count);

$list = $text_examine_v2_obj->get_text_pass_list(false,$date,$type,$audit_id,$user_id,$where_str,'add_time DESC,id DESC',$page_obj->limit());
...
//$text_examine_v2_obj->get_text_pass_list()
