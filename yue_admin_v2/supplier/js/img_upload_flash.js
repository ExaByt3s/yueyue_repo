define(function(require, exports, module) {
    ...
    function getSwfupload(_swfPlaceholderId,flash_type,id_num,options,img_mark,construct_img_mark) {
        ...
        var _swfupload = new SWFUpload({
            ...
            upload_url:'http://imgup-yue.yueus.com/ultra_upload_service/yueyue_upload_act.php',//返回260的图，入库是320的图
            ...
            upload_success_handler: function (file, serverData, responseReceived) {
                ...
                if( response != '' )
                {
                    ...
                    var big_img = response_json.url.replace("img16\.poco\.cn", "image16-d\.poco\.cn");
                    if(flash_type=="cover_img_btn")
                    {
