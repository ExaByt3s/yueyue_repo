...
<div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.php">新报表后台管理</a>
        </div>
        <!-- Top Menu Items -->
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav side-nav" id="side-menu">
                <li>
                    <a href="index.php"><i class="fa fa-fw fa-dashboard"></i>桌面导航</a>
                </li>
                <li>
                    <a href="week_order_collect_list.php"><i class="fa fa-fw fa-table"></i>周订单汇总列表</a>
                </li>
                <li>
                    <a href="month_order_collect_list.php"><i class="fa fa-fw fa-table"></i>月订单汇总列表</a>
                </li>
            </ul>
        </div>
        <!-- /.navbar-collapse -->
