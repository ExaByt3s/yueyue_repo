...
$sql = "select * from pai_db.pai_model_comment_log_tbl";
...
foreach($comment_arr as $val)
{
    ...
    $insert_arr['from_user_id'] = $val['cameraman_user_id'];
    $insert_arr['to_user_id'] = $val['model_user_id'];
    $insert_arr['order_id'] = 0;
    $insert_arr['goods_id'] = $goods_id;
    $insert_arr['overall_score'] = $val['overall_score'];
    $insert_arr['match_score'] = 5;
    $insert_arr['manner_score'] = 5;
    $insert_arr['quality_score'] = 5;
    ...
    $sql = "insert into mall_db.mall_comment_seller_tbl set ".$insert_str;
