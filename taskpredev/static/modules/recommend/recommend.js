define('recommend', function(require, exports, module){ 'use strict';
            ...
            $('[question_titleid]').each(function(i) {
                ...
                switch (type)
                {
                    ...
                    case '4' :
                        ...
                        var message_val = $(this).find('textarea').val().trim().toString();
                    ...
                    case '6' :
                        ...
                        {
                            var input_txt_val = $(this).find('.input-text').val() ;
                    ...
                    case '7' :
                        ...
                        if ($(this).find('[data-style-time]').length > 0) 
                        {
                            ...
                            var data_style_time_1_val = $(this).find('[data-style-time]').find('#data-style-time-1').val() ;
                            var data_style_time_2_val = $(this).find('[data-style-time]').find('#data-style-time-2').val() ;

                            if (data_style_time_1_val == 0 && data_style_time_2_val == 0) 
                            {
                                    error_tips($that,$that.find('.title').html() );
                                    return false;
                            }
                            ...
                            data.push({
                                message : data_style_time_1_val +':'+ data_style_time_2_val,
