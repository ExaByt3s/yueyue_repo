...
/**
	...
	*
	* CVS ID: $Id: class.smarttemplateparser.php,v 1.9 2006/07/02 22:17:15 endelwar Exp $
	*/
	...
	function compile( $compiled_template_filename = '' )
	{
		...
		if (preg_match_all('/{([a-zA-Z0-9_]+):[ ]?([^}]*)}/', $page, $var))
		{
			foreach ($var[2] as $cnt => $tag)
			{
				...
				$extension  =  $var[1][$cnt];
				if( file_exists(dirname(__FILE__) . "/smarttemplate_extensions/smarttemplate_extension_{$extension}.php") )
				{
