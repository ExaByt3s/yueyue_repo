 ...
 */
/*
class OAuthException_v2 extends Exception 
{
	// pass
}
...
class SaeTOAuthV2 {
	 ...
	 * @return array
	 */
	function getAuthorizeURL( $url, $response_type = 'code', $state = NULL, $display = NULL ,$forcelogin = "true", $scope = true) {
		$params = array();
		...
		if($scope) $params['scope'] = 'follow_app_official_microblog';
	...
	function getAccessToken( $type = 'code', $keys ) {
		...
		{
			return false;
			//throw new OAuthException_v2("wrong auth type");
		}
		...
		{
			return false;
			//throw new OAuthException_v2("get access token failed." . $token['error']);
		}
		return $token;
	}
...
class SaeTClientV2
{
	...
	function show_user_counts( $uids )
	{
		$params = array();
		$params['uids'] = $uids;
