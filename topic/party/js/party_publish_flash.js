            ...
            flash_url: 'http://my.poco.cn/module_common/swfupload/2.2.0/swfupload.swf',
                   ...
                   else if(numFilesQueued>0)
                   {
                        ...
                        try 
                        {
                            ...
                            else if(flash_type=="model_btn")
                            {
                                ...
                                var left_can_queue_num = 5-cur_li_len;
                ...
                upload_start_handler: function (file) {
                    ...
                    if(flash_type=="model_btn")
                    {
                        ...
                        {//如果图片li没有建立则不能上传（取消）
                            ...
                            //取消后，标记的结构块加1，图片块加1
                            //_swfupload.customSettings.construct_img_mark = parseInt(_swfupload.customSettings.construct_img_mark)+1;
                ...
                upload_success_handler: function (file, serverData, responseReceived) {
                        ...
                        if( response != '' )
                        {
                            ...
                            if(flash_type=="cover_img_btn")
                            {
                                $(".J_upload_cover_img[data-mark='1']").attr("src",small_img);
                                $(".J_upload_cover_img_input_item[data-mark='1']").val(response_json.itemId);
                                $(".J_upload_cover_img_input[data-mark='1']").val(response_json.mediumThumbnailUrl);
                            ...
                            else if(flash_type=="model_btn")
                            {
                                ...
                                //alert(img_mark);
                                $(".J_upload_img[data-mark='"+id_num+"_"+tmp_file_id+"']").attr("src",small_img);
                                $(".J_upload_img_input[data-mark='"+id_num+"_"+tmp_file_id+"']").val(response_json.mediumThumbnailUrl);
