 ...
 * @version 0.2.0 拖动功能使用新算法
 * @example new Slider({wrap: '#slider'}); ../../example/example-2.html
 */


(function($) {
	/**
	 * @description 配置组件，布局依据example-2.html
	...
	$.extend(Slider.prototype, {
		...
		_initHTML: function() {
			...
			self.length = self.picUl.children('li').width(self.width).length;
