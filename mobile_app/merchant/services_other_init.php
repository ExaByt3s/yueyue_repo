...
$prices = $goods_info['default_data']['prices']['value'];  // 价格
$init_list['prices'] = array(
    'type' => '4', //控件类型
    'id' => 'default_data.prices', // 入库键值
    'title' => '价格', // 显示标题
    'value' => empty($prices) ? '' : $prices, // 显示值
    'option_value' => '', // 入库值
...
if (version_compare($version, '1.3', '>')) {
    ...
    unset($init_list['a8abb4bb284b5b27aa7cb790dc20f80b'], $init_list['prices'], $init_list['1651cf0d2f737d7adeab84d339dbabd3']);
}
...
if (version_compare($version, '1.3', '>')) {
    ...
    // 处理 服务类型 名称
    $classify_name_ = array(
        '15d4e891d784977cacbfcbb00c48f133' => '课程类(兴趣教学/手艺指导)',
        'c203d8a151612acf12457e4d67635a95' => '商品类(原创设计/手工作品)',
        '13f3cf8c531952d72e5847c4183e6910' => '服务类(技能服务/商务合作)',
    );
    $class_options_list = array();
    foreach ($first_options_init['classify_options'] as $options) {
        $option_value = $options['option_value'];
        $class_options_list[] = array(
            'value' => $classify_name_[$option_value],
            'option_value' => $option_value,
        );
    }
    $first_options_init['classify_options'] = $class_options_list;
}
