...
foreach ($att_data as $val) {
    ...
    $choice_num = 0;
    $input_type = 2;
    if (in_array($key, array('m_cup', 'hz_othergoodat', 'ot_otherlabel'))) {
        $input_type = 1;
    }
    $options = array();
    ...
    $attr_list[$type_k][] = array(
        'type' => $att_type, //控件类型，1、跳页选择； 2、弹框选择；3、弹页输入；4、当前输入
        'id' => $key,  // key
...
$type_list_ = interface_type_list();  // 评论列表
...
$style_ico_arr = array(
    'm' => array(
        'type_id' => '31',
        'title' => '模特商家',
        'image' => 'http://image17-c.poco.cn/yueyue/cms/20150710/4810201507101813076653044.png'
    ),
    'p' => array(
        'type_id' => '40',
        'title' => '摄影师商家',
        'image' => 'http://image17-c.poco.cn/yueyue/cms/20150710/22142015071018144041408929.png', // 摄影服务
    ),
    'yp' => array(
        'type_id' => '12',
        'title' => '影棚商家',
        'image' => 'http://image17-c.poco.cn/yueyue/cms/20150710/27512015071018133169504499.png', // 影棚租赁
    ),
    't' => array(
        'type_id' => '5',
        'title' => '培训师商家',
        'image' => 'http://image17-c.poco.cn/yueyue/cms/20150710/55652015071018135068618082.png', // 摄影培训
    ),
    'hz' => array(
        'type_id' => '3',
        'title' => '化妆师商家',
        'image' => 'http://image17-c.poco.cn/yueyue/cms/20150710/80182015071018153952515487.png', // 化妆服务
    ),
    'ms' => array(
        'type_id' => '41',
        'title' => '美食达人商家',
        'image' => 'http://image19-d.yueus.com/yueyue/20151012/20151012153516_743651_10002_34783.png?40x40_130', // 约美食
    ),
    'ot' => array(
        'type_id' => '43',
        'title' => '其他服务商家',
        'image' => 'http://image19-d.yueus.com/yueyue/20151012/20151012153542_172128_10002_34786.png?40x40_130', // 约有趣
    ),
);
