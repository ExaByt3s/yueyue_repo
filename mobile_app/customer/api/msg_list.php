...
if (empty($receiver_id)) {
    ...
    $json = array(
        'type' => 'history',
        'mode' => 'cross',
        'send_user_id' => 'yuebuyer/' . $user_id,
        'to_user_id' => 'yueseller/' . $receiver_id,
        'start_time' => 0,
        'end_time' => floatval($request_time),
...
$options['data']['list'] = $list;
return $cp->output($options, FALSE);
