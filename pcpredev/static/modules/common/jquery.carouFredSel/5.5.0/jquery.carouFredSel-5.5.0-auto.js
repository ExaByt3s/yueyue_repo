define('common/jquery.carouFredSel/5.5.0/jquery.carouFredSel-5.5.0-auto', function(require, exports, module){ /*	
 *	jQuery carouFredSel_auto 5.5.0
...
(function($) {
	...
	if ($.fn.carouFredSel_auto) return;

	$.fn.carouFredSel_auto = function(options, configs) {
		if (this.length == 0) {
		...
		if (this.length > 1) {
			return this.each(function() {
				$(this).carouFredSel_auto(options, configs);
			});
		}
		...
		$cfs._cfs_init = function(o, setOrig, start) {
			...
			if (setOrig) opts_orig = $.extend(true, {}, $.fn.carouFredSel_auto.defaults, o);

			opts = $.extend(true, {}, $.fn.carouFredSel_auto.defaults, o);
...
if (opts.responsive) {
	...
	opts[opts.d['width']] = visb * newS;
			...
			if (typeof opts.pagination.anchorBuilder	!= 'function'
					&& opts.pagination.anchorBuilder	!== false)		opts.pagination.anchorBuilder	= $.fn.carouFredSel_auto.pageAnchorBuilder;
...
if (crsl.upDateOnWindowResize) {
	$(window).bind(cf_e('resize', conf, false, true, true), function(e) {
		...
		var crsl = {
			...
			queu = [],
			conf = $.extend(true, {}, $.fn.carouFredSel_auto.configs, configs),
			opts = {},
			opts_orig = options,
			$wrp = $cfs.wrap('<'+conf.wrapper.element+' class="'+conf.wrapper.classname+'" />').parent();

		conf.selector		= $cfs.selector;
		conf.serialNumber	= $.fn.carouFredSel_auto.serialNumber++;
	...
	$.fn.carouFredSel_auto.serialNumber = 1;
	$.fn.carouFredSel_auto.defaults = {
		'synchronise'	: false,
		'infinite'		: true,
		'circular'		: true,
		'responsive'	: true,
	...
	$.fn.carouFredSel_auto.pageAnchorBuilder = function(nr, itm) {
	...
	function debug(d, m) {
		...
		if (typeof m == 'string') m = 'carouFredSel_auto'+s+': ' + m;
		else m = ['carouFredSel_auto'+s+':', m];
	...
	$.fn.caroufredsel = function(o, c) {
		return this.carouFredSel_auto(o, c);
	};
