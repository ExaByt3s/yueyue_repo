...
function PCB_SIM_TOUCH_CLICK(xpath,random,x,y)
{
	try{																
		...
		PCB_TRACE("touch click begin ->" + element.localName + "." + element.className + " (X=" + x + " Y=" + y + ")");												
...
PCB_TRACE("event sim version 1.3 ready");																
