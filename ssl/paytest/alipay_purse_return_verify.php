...
function output_json($info_arr){
	...
	ecpay_log_class::add_log($info_arr, 'alipay_purse_verify_test_RETURN', 'alipay_purse_verify_test_RETURN');
...
ecpay_log_class::add_log($log_arr, 'alipay_purse_verify_test_NEW', 'alipay_purse_verify_info_test_NEW');
