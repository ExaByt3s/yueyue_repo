define("utility/hammer/plugins/jquery.hammer/1.1.3/jquery.hammer-debug", ["$-debug", "utility/hammer/1.1.3/hammer-debug"], function(require) {

    var $ = require("$-debug");
    var Hammer = require("utility/hammer/1.1.3/hammer-debug");
