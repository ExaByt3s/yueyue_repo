...
//取得模板对象
$tpl = $my_app_pai->getView('card.tpl.htm');
...
foreach ($obj['model_pic'] as $k => $val) {
	$obj['new_max_model_pic'][] =  array( 'img' => str_replace ( '_260.', '_640.', $val['img'] ) ) ;
}
...
//二维码生成
$erweima = 'http://www.yueus.com/share_card/' . $user_id;
