...
$tpl = $my_app_pai->getView('withdraw.tpl.htm');
...
$bind_status = $pai_bind_account_obj->get_bind_status($yue_login_id,'alipay_account');
				...
				switch ($bind_status['status']) {
					...
					case '0':
						...
						$status_resault['data'] = $bind_status['third_account'];
						break;
					case '1':
						$status_resault['code'] = 1;
...
$name = $pai_bind_account_obj->get_info_by_user_id($yue_login_id,'alipay_account');
$tpl->assign('account_name', $name);
$tpl->output();
?>