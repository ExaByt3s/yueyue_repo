...
if( $type=='mall_order' ) //商城订单
{
	...
	if( $yue_login_id==$buyer_user_id )
	{
		 ...
		 */
		$pay_rst = $mall_order_obj->submit_pay_order($order_sn, $yue_login_id, $available_balance, $is_available_balance, $third_code, $redirect_url, $notify_url, $coupon_sn);
		if( $pay_rst['result']==2 )
		{
...
{
	$tpl = $my_app_pai->getView('pay_jump_test.tpl.htm');
}
else
{
	$tpl = $my_app_pai->getView('pay_jump_v2.tpl.htm');
}
