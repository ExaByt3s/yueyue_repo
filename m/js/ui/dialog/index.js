define(function(require, exports, module) {
    ...
    var Dialog = View.extend({
        attrs: {
            ...
            hasMask: true,
            template: dialogTpl,
            mask_is_close_btn : true //点击半透明层是否关闭此组件 默认是 nolest 2015-02-10
        },
        ...
        _parseElement: function() {
            ...
            self.set('templateModel', {
                ...
                buttons: buttons,
                mask_is_close_btn : !self.get('mask_is_close_btn')? self.get('mask_is_close_btn') : true //点击半透明层是否关闭此组件 默认是 nolest 2015-02-10
            });
