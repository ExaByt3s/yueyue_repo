define('base/img_process',['megapix_img','exif','ua'],function(require, exports)
{
	var megapix_img = require('megapix_img')
	var exif = require('exif')
	var ua = require('ua')

	exports.start_img_process = function(img_file,process_options,callback)
	{
		var process_options = process_options || {}

		var max_width = process_options.max_width || 600
		var max_height = process_options.max_height || 6000
		var quality = process_options.quality || 0.99
		var type = process_options.type || "image/jpeg"
	...
	exports.support_process = function()
	{
	...
	exports.can_web_upload_img = function()
	{
		var not_support_process = !this.support_process()
		var ios_can_select_img = ua.ios_version < "6.0"
		var is_weixin_android = typeof(WeixinJSBridge)!="undefined" && ua.isAndroid
        var is_bad_android = ua.isAndroid && ua.android_version >='4.4';


		if(not_support_process || ios_can_select_img || is_weixin_android || is_bad_android)
		{
			return false
		}
		else
...
define('base/megapix_img',[],function(require, exports)
{
   ...
   */
  function renderImageToDataURL(img, options, doSquash , type) {
    var canvas = document.createElement('canvas');
  ...
  MegaPixImage.prototype.render = function(target, options) {
    ...
    if (tagName === 'img') 
	{
      ...
      target.src = renderImageToDataURL(this.srcImage, opt, doSquash , options.type);

		if(typeof(options.render_callback)=="function")
		{
			options.render_callback.call(this,target.src)
		}
...
define('base/exif',[],function(require, exports)
{
