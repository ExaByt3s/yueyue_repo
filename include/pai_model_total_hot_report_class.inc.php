 ...
 * @version 1
 */
 class pai_model_total_hot_report_class extends POCO_TDG
 {
 	/**
 	 * 构造函数
 	 *
 	...
 	public function __construct()
 	{
 		...
 		$this->setTableName ( 'yueyue_model_total_hot_tbl_20150415' );
 		//排除的用户
 	...
 	public function select_table($date)
 	{
 		...
 		$sign_tab =  'yueyue_model_total_hot_tbl_'.$table_num;
