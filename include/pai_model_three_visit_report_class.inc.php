 ...
 * @version 1
 */
 class pai_model_three_visit_report_class extends POCO_TDG
 {
 	/**
 	 * 构造函数
 	 *
 	...
 	public function __construct()
 	{
 		...
 		$this->setTableName ( 'yueyue_model_three_visit_tbl_20150417' );
 		//排除的用户
 	 ...
 	 *
 	 * */
 	public function get_three_visit_list($date, $b_select_count = false,$location_id = 0 ,$where_str = '', $order_by = 'user_id DESC', $limit = '0,10', $fields = '*')
 	{
 		//处理数据
 	...
 	public function select_table($date)
 	{
 		...
 		$sign_tab =  'yueyue_model_three_visit_tbl_'.$table_num;
