...
class yueyue_attemper_service_class
{
	var $server_conf = array(
		0=>array("ip"=>"113.107.204.189","port"=>9984),		//统计调度 113.107.204.189 port:9984
	);
	...
	function yueyue_attemper_service_class($server_id=0,$time_out=30 )
	{
