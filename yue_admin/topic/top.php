...
<div id="header" class="header">
	...
	<div class="nav">&nbsp;&nbsp;&nbsp;&nbsp;欢迎你！<?php echo get_user_nickname_by_user_id($yue_login_id);?>	&nbsp;&nbsp;&nbsp;&nbsp;<a href='logout.php'>退出系统</a></div>
	<div class="topmenu" id="top_tag">
		<ul>
			<li><span id="top_menu_1" class="current"><a href="#this">专题模块</a></span></li>
		</ul>
	</div>
