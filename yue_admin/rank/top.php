...
<div id="header" class="header">
	...
	<div class="topmenu" id="top_tag">
		<ul>
			<li><span id="top_menu_1" class="current"><a href="#this">榜单模块</a></span></li>
			<li><span id="top_menu_2"><a href="#this">促销模块</a></span></li>
			<li><span id="top_menu_3"><a href="#this">榜单内容展示</a></span></li>
            <li style="display: none;"><span id="top_menu_4"><a href="#this">版本开通</a></span></li>
		</ul>
	</div>
