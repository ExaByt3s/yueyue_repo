...
<div id="header" class="header">
	...
	<div class="nav">&nbsp;&nbsp;&nbsp;&nbsp;欢迎你！
	<?php 
		$user_objj  = POCO::singleton('pai_user_class');
		$nickname = $user_objj->get_user_nickname_by_user_id($yue_login_id);
		echo $nickname;
	?>	<i>|</i><a href="logout.php">[退出]</a> </div>
	<div class="topmenu" id="top_tag">
		<ul>
			<li><span id="top_menu_1"><a href="#this">推送模特</a></span></li>
		</ul>
	</div>
	<div class="header_footer"></div>
</div>
<script>
switch_tab('top_tag','top_menu_','nav_','current',1);
</script>
<!--header-->
<?php
