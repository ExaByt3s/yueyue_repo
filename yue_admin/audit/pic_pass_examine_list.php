...
//查询条件
$where_str = "1 AND img_type = '".mysql_escape_string($act)."'";
...
$total_count = $pic_examine_obj->get_pic_pass_examine_list(true, $where_str,'','','', $year, $month);
$page_obj->set ( $show_count, $total_count );
$list = $pic_examine_obj->get_pic_pass_examine_list(false, $where_str, $order_by = 'id DESC', $page_obj->limit(), $fields = '*',$year, $month);
