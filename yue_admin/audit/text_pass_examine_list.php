...
$text_examine_obj     = POCO::singleton ('pai_text_pass_examine_class');
$tpl = new SmartTemplate("text_pass_examine_list.tpl.htm");
...
$page_obj->setvar($type);
$total_count = $text_examine_obj->get_text_pass_examine_list(true, $where_str,$year, $month);
$page_obj->set ( $show_count, $total_count );
$list = $text_examine_obj->get_text_pass_examine_list(false, $where_str,$year, $month, $order_by = 'user_id DESC,id DESC', $page_obj->limit(), $fields = '*');
