...
*/
  ...
  $org_id  = isset($_INPUT['org_id']) ? intval($_INPUT['org_id']) : 0;
  if (empty($user_id)) 
  {
  ...
  $page_obj->setvar(array('user_id' => $user_id, 'org_id' => $org_id));
  $total_count = $order_obj->get_order_list_by_user_id($user_id,$org_id,'', $order_by ='', $fields= '*', true);
  $page_obj->set ( $show_count, $total_count );
  $list      = $order_obj->get_order_list_by_user_id($user_id,$org_id,$page_obj->limit(), $order_by ='date_time DESC', $fields= '*');
