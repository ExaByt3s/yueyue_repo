    ...
    //关于影棚租凭
     $property_for_search_ary[12] = array(
          ...
          array(
            ...
            'data_type'=>1,
            'select_type'=>1,  
            'function_param'=>array('type_id'=>12,'parent_id'=>20),
          ),
          array(
            'text'=>'面积',
            'name'=>'name_19',
     ...
     $property_for_search_ary[43] = array(
         ...
         array(
            ...
            'data_type'=>1,
            'select_type'=>1, 
            'function_param'=>array('type_id'=>43,'parent_id'=>440),
          ),
         array(
            'text'=>'价格',
            'name'=>'prices_list',
            ...
            'select_type'=>1, 
            'data'=>array(
                array('key'=>'33','val'=>'100以下'),
                array('key'=>'34','val'=>'100-300'),
                array('key'=>'35','val'=>'300-500'),
                array('key'=>'36','val'=>'500-1000'),
     ...
     $property_for_search_ary[5] = array(
         ...
         array(
            ...
            'data_type'=>1,
            'select_type'=>1, 
            'function_param'=>array('type_id'=>5,'parent_id'=>400),
          ),
         array(
            'text'=>'美体、模特标签',
            'name'=>'detail[402]',
            'data_type'=>1,
            'select_type'=>1, 
            'function_param'=>array('type_id'=>5,'parent_id'=>402),
          ),
         array(
           'text'=>'上课方式',
            'name'=>'detail[317]', 
            'data_type'=>1,
            'select_type'=>1, 
            'function_param'=>array('type_id'=>5,'parent_id'=>317),
         ),
         array(
           'text'=>'价钱',
            'name'=>'price_s_e', 
            ...
            'select_type'=>1, 
            'data'=>array(
                array('key'=>'0,100','val'=>'100元以下'),
                array('key'=>'101,1000','val'=>'101-1000元'),
                array('key'=>'1001,2000','val'=>'1001-2000元'),
                array('key'=>'2001,3000','val'=>'2001-3000元'),
                array('key'=>'3000,99999','val'=>'3000以上'),
            ),
         ),
     );
