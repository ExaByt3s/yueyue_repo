<?php
  ...
  */
  ...
  $tpl = new SmartTemplate("cameraman_total_hot_report_list.tpl.htm");
  ...
  $list = $cameraman_total_hot_obj->get_total_hot_list($date,false,$location_id,$where_str,'details_price DESC,details_count DESC,user_id DESC','0,30','*');
  ...
  if($act == 'export')
  {
    ...
    foreach ($list as $key=>$vo)
    {
  	 ...
  	 $fileName = '摄影师消费总榜';
  	 $title    = '摄影师消费总榜';
  	 $headArr  = array("摄影师ID","摄影师昵称","消费金额");
