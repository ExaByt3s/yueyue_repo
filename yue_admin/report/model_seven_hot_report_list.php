 ...
 */
 ...
 $tpl   = new SmartTemplate("model_seven_hot_report_list.tpl.htm");
 ...
 $list = $model_seven_hot_obj->get_seven_hot_list($date,false,$location_id,$where_str,$order_by,'0,30','*');
