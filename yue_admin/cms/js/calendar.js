...
function WebCalendar() //初始化日历的设置
{
    ...
    this.iframe     = document.getElementById("meizzCalendarIframe") || window.frames("meizzCalendarIframe"); //日历的 iframe 载体
...
{
    if(WebCalendar.eventSrc != (navigator.userAgent.indexOf('MSIE') != -1 ? window. event.srcElement : event.target)) hiddenCalendar();
}
//-->